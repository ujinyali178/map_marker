...
public class e<K, V> {
    ...
    public final synchronized String toString() {
        ...
        int i4;
        i3 = this.hitCount;
        i4 = this.missCount + i3;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i4 != 0 ? (i3 * 100) / i4 : 0));
    }
