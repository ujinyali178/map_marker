...
final class Types {
    private static final Joiner COMMA_JOINER = Joiner.on(", ").useForNull(BuildConfig.TRAVIS);
    ...
    private static final class TypeVariableImpl<D extends GenericDeclaration> {
        ...
        TypeVariableImpl(D d3, String str, Type[] typeArr) {
    ...
    static <D extends GenericDeclaration> TypeVariable<D> newArtificialTypeVariable(D d3, String str, Type... typeArr) {
        if (typeArr.length == 0) {
