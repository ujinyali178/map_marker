...
public final class MutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    @CheckForNull
    private <T extends B> T trustedPut(TypeToken<T> typeToken, @ParametricNullness T t3) {
        return this.backingMap.put(typeToken, t3);
    }
    ...
    public <T extends B> T putInstance(TypeToken<T> typeToken, @ParametricNullness T t3) {
        return (T) trustedPut(typeToken.rejectTypeVariables(), t3);
    }

    @Override // com.google.common.reflect.TypeToInstanceMap
    @CheckForNull
    public <T extends B> T putInstance(Class<T> cls, @ParametricNullness T t3) {
        return (T) trustedPut(TypeToken.of((Class) cls), t3);
    }
}
