...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    public static class Builder<K, V> {
        ...
        public Builder<K, V> putAll(K k3, Iterable<? extends V> iterable) {
            ...
            if (collection != null) {
                while (it.hasNext()) {
                    V next = it.next();
                    CollectPreconditions.checkEntryNotNull(k3, next);
                    collection.add(next);
                }
                return this;
            }
            ...
            while (it.hasNext()) {
                V next2 = it.next();
                CollectPreconditions.checkEntryNotNull(k3, next2);
                newMutableValueCollection.add(next2);
            }
            this.builderMap.put(k3, newMutableValueCollection);
            return this;
        }

        public Builder<K, V> putAll(K k3, V... vArr) {
            return putAll((Builder<K, V>) k3, Arrays.asList(vArr));
        }
    }
    ...
    ImmutableMultimap(ImmutableMap<K, ? extends ImmutableCollection<V>> immutableMap, int i3) {
    ...
    public static <K, V> ImmutableMultimap<K, V> of(K k3, V v3, K k4, V v4) {
        return ImmutableListMultimap.of((Object) k3, (Object) v3, (Object) k4, (Object) v4);
    }

    public static <K, V> ImmutableMultimap<K, V> of(K k3, V v3, K k4, V v4, K k5, V v5) {
        return ImmutableListMultimap.of((Object) k3, (Object) v3, (Object) k4, (Object) v4, (Object) k5, (Object) v5);
    }

    public static <K, V> ImmutableMultimap<K, V> of(K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6) {
        return ImmutableListMultimap.of((Object) k3, (Object) v3, (Object) k4, (Object) v4, (Object) k5, (Object) v5, (Object) k6, (Object) v6);
    }

    public static <K, V> ImmutableMultimap<K, V> of(K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7) {
        return ImmutableListMultimap.of((Object) k3, (Object) v3, (Object) k4, (Object) v4, (Object) k5, (Object) v5, (Object) k6, (Object) v6, (Object) k7, (Object) v7);
    }
    ...
    public UnmodifiableIterator<Map.Entry<K, V>> entryIterator() {
        return new UnmodifiableIterator<Map.Entry<K, V>>() { // from class: com.google.common.collect.ImmutableMultimap.1
            ...
            public Map.Entry<K, V> next() {
                ...
                K k3 = this.currentKey;
                Objects.requireNonNull(k3);
                return Maps.immutableEntry(k3, this.valueItr.next());
            }
        };
    }
    ...
    @Override // com.google.common.collect.AbstractMultimap, com.google.common.collect.Multimap
    @Deprecated
    public final boolean putAll(K k3, Iterable<? extends V> iterable) {
        throw new UnsupportedOperationException();
    }
