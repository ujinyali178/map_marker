...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private class Column extends Maps.ViewCachingAbstractMap<R, V> {
                    ...
                    if (next.getValue().containsKey(Column.this.columnKey)) {
                        return new AbstractMapEntry<R, V>() { // from class: com.google.common.collect.StandardTable.Column.EntrySetIterator.1EntryImpl
                            ...
                            public V setValue(V v3) {
                                return (V) NullnessCasts.uncheckedCastNullableTToT(((Map) next.getValue()).put(Column.this.columnKey, Preconditions.checkNotNull(v3)));
                            }
                        };
                    }
                }
        ...
        public V put(R r3, V v3) {
            return (V) StandardTable.this.put(r3, this.columnKey, v3);
        }
    ...
    class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public V put(C c3, V v3) {
            ...
            Map<C, V> map = this.backingRowMap;
            return (map == null || map.isEmpty()) ? (V) StandardTable.this.put(this.rowKey, c3, v3) : this.backingRowMap.put(c3, v3);
        }
        ...
        public V remove(@CheckForNull Object obj) {
            ...
            V v3 = (V) Maps.safeRemove(map, obj);
            maintainEmptyInvariant();
            return v3;
        }
            ...
            public Iterator<Map.Entry<R, Map<C, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.backingMap.keySet(), new Function<R, Map<C, V>>() { // from class: com.google.common.collect.StandardTable.RowMap.EntrySet.1
                    ...
                    public Map<C, V> apply(R r3) {
                        return StandardTable.this.row(r3);
                    }
                });
            }
    ...
    @Override // com.google.common.collect.AbstractTable, com.google.common.collect.Table
    @CheckForNull
    public V put(R r3, C c3, V v3) {
        Preconditions.checkNotNull(r3);
        Preconditions.checkNotNull(c3);
        Preconditions.checkNotNull(v3);
        return getOrCreate(r3).put(c3, v3);
    }
