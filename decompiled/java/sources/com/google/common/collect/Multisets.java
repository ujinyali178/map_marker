...
public final class Multisets {
    ...
    private static final class FilteredMultiset<E> extends ViewMultiset<E> {
        ...
        public int add(@ParametricNullness E e3, int i3) {
            Preconditions.checkArgument(this.predicate.apply(e3), "Element %s does not match predicate %s", e3, this.predicate);
            return this.unfiltered.add(e3, i3);
        }
    ...
    static class ImmutableEntry<E> extends AbstractEntry<E> implements Serializable {
        ...
        ImmutableEntry(@ParametricNullness E e3, int i3) {
            this.element = e3;
            this.count = i3;
                ...
                return new AbstractIterator<E>() { // from class: com.google.common.collect.Multisets.4.1
                    ...
                    protected E computeNext() {
                        while (it.hasNext()) {
                            ...
                            E e3 = (E) entry.getElement();
                            if (entry.getCount() > multiset2.count(e3)) {
                                return e3;
                            }
                        }
                        return endOfData();
    ...
    public static <E> Multiset.Entry<E> immutableEntry(@ParametricNullness E e3, int i3) {
    ...
    static <E> int setCountImpl(Multiset<E> multiset, @ParametricNullness E e3, int i3) {
        CollectPreconditions.checkNonnegative(i3, "count");
        int count = multiset.count(e3);
        int i4 = i3 - count;
        if (i4 > 0) {
            multiset.add(e3, i4);
        } else if (i4 < 0) {
            multiset.remove(e3, -i4);
        }
        return count;
    }

    static <E> boolean setCountImpl(Multiset<E> multiset, @ParametricNullness E e3, int i3, int i4) {
        CollectPreconditions.checkNonnegative(i3, "oldCount");
        CollectPreconditions.checkNonnegative(i4, "newCount");
        if (multiset.count(e3) != i3) {
            return false;
        }
        multiset.setCount(e3, i4);
        return true;
    }
