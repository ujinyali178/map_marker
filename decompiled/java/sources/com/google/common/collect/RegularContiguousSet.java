...
final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
    ...
    ImmutableList<C> createAsList() {
        return this.domain.supportsFastOffset ? new ImmutableAsList<C>() { // from class: com.google.common.collect.RegularContiguousSet.3
            ...
            public C get(int i3) {
                ...
                return (C) regularContiguousSet.domain.offset(regularContiguousSet.first(), i3);
            }
        } : super.createAsList();
    }
    ...
    public ContiguousSet<C> headSetImpl(C c3, boolean z3) {
        return intersectionInCurrentDomain(Range.upTo(c3, BoundType.forBoolean(z3)));
    }
    ...
    public ContiguousSet<C> subSetImpl(C c3, boolean z3, C c4, boolean z4) {
        return (c3.compareTo(c4) != 0 || z3 || z4) ? intersectionInCurrentDomain(Range.range(c3, BoundType.forBoolean(z3), c4, BoundType.forBoolean(z4))) : new EmptyContiguousSet(this.domain);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.common.collect.ContiguousSet, com.google.common.collect.ImmutableSortedSet
    public ContiguousSet<C> tailSetImpl(C c3, boolean z3) {
        return intersectionInCurrentDomain(Range.downTo(c3, BoundType.forBoolean(z3)));
    }
