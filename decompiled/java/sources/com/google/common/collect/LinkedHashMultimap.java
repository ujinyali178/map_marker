...
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
    ...
    static final class ValueEntry<K, V> extends ImmutableEntry<K, V> implements ValueSetLink<K, V> {
        ...
        ValueEntry(@ParametricNullness K k3, @ParametricNullness V v3, int i3, @CheckForNull ValueEntry<K, V> valueEntry) {
            super(k3, v3);
        ...
        boolean matchesValue(@CheckForNull Object obj, int i3) {
            return this.smearedValueHash == i3 && com.google.common.base.Objects.equal(getValue(), obj);
        }
    ...
    final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        ValueSet(@ParametricNullness K k3, int i3) {
            this.key = k3;
            this.hashTable = new ValueEntry[Hashing.closedTableSize(i3, 1.0d)];
        }
        ...
        private void rehashIfNecessary() {
            if (Hashing.needsResizing(this.size, this.hashTable.length, 1.0d)) {
                ...
                for (ValueSetLink<K, V> valueSetLink = this.firstEntry; valueSetLink != this; valueSetLink = valueSetLink.getSuccessorInValueSet()) {
                    ...
                    int i4 = valueEntry.smearedValueHash & i3;
                    valueEntry.nextInValueBucket = valueEntryArr[i4];
        ...
        public boolean add(@ParametricNullness V v3) {
            ...
            for (ValueEntry<K, V> valueEntry2 = valueEntry; valueEntry2 != null; valueEntry2 = valueEntry2.nextInValueBucket) {
                if (valueEntry2.matchesValue(v3, smearedHash)) {
                    return false;
                }
            }
            ValueEntry<K, V> valueEntry3 = new ValueEntry<>(this.key, v3, smearedHash, valueEntry);
    ...
    private LinkedHashMultimap(int i3, int i4) {
        super(Platform.newLinkedHashMapWithExpectedSize(i3));
        this.valueSetCapacity = 2;
        CollectPreconditions.checkNonnegative(i4, "expectedValuesPerKey");
        this.valueSetCapacity = i4;
    ...
    public static <K, V> LinkedHashMultimap<K, V> create(int i3, int i4) {
        return new LinkedHashMultimap<>(Maps.capacity(i3), Maps.capacity(i4));
    }
    ...
    Collection<V> createCollection(@ParametricNullness K k3) {
        return new ValueSet(k3, this.valueSetCapacity);
    }
    ...
    public Set<V> replaceValues(@ParametricNullness K k3, Iterable<? extends V> iterable) {
        return super.replaceValues((LinkedHashMultimap<K, V>) k3, (Iterable) iterable);
    }
