...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    private abstract class Itr<T> implements Iterator<T> {
        ...
        abstract T output(@ParametricNullness K k3, @ParametricNullness V v3);
    ...
    class NavigableAsMap extends AbstractMapBasedMultimap<K, V>.SortedAsMap implements NavigableMap<K, Collection<V>> {
        ...
        public Map.Entry<K, Collection<V>> ceilingEntry(@ParametricNullness K k3) {
            Map.Entry<K, Collection<V>> ceilingEntry = sortedMap().ceilingEntry(k3);
        ...
        public K ceilingKey(@ParametricNullness K k3) {
            return sortedMap().ceilingKey(k3);
        }
        ...
        public Map.Entry<K, Collection<V>> floorEntry(@ParametricNullness K k3) {
            Map.Entry<K, Collection<V>> floorEntry = sortedMap().floorEntry(k3);
            if (floorEntry == null) {
                return null;
            }
        ...
        public NavigableMap<K, Collection<V>> headMap(@ParametricNullness K k3, boolean z3) {
            return new NavigableAsMap(sortedMap().headMap(k3, z3));
        }
        ...
        public Map.Entry<K, Collection<V>> higherEntry(@ParametricNullness K k3) {
            Map.Entry<K, Collection<V>> higherEntry = sortedMap().higherEntry(k3);
            if (higherEntry == null) {
                return null;
            }
        ...
        public Map.Entry<K, Collection<V>> lowerEntry(@ParametricNullness K k3) {
            Map.Entry<K, Collection<V>> lowerEntry = sortedMap().lowerEntry(k3);
            if (lowerEntry == null) {
                return null;
            }
        ...
        public NavigableMap<K, Collection<V>> subMap(@ParametricNullness K k3, boolean z3, @ParametricNullness K k4, boolean z4) {
            return new NavigableAsMap(sortedMap().subMap(k3, z3, k4, z4));
        }
        ...
        public NavigableMap<K, Collection<V>> tailMap(@ParametricNullness K k3, boolean z3) {
            return new NavigableAsMap(sortedMap().tailMap(k3, z3));
        }
    ...
    class NavigableKeySet extends AbstractMapBasedMultimap<K, V>.SortedKeySet implements NavigableSet<K> {
        ...
        public NavigableSet<K> headSet(@ParametricNullness K k3, boolean z3) {
            return new NavigableKeySet(sortedMap().headMap(k3, z3));
        }
        ...
        public NavigableSet<K> subSet(@ParametricNullness K k3, boolean z3, @ParametricNullness K k4, boolean z4) {
            return new NavigableKeySet(sortedMap().subMap(k3, z3, k4, z4));
        }
        ...
        public NavigableSet<K> tailSet(@ParametricNullness K k3, boolean z3) {
            return new NavigableKeySet(sortedMap().tailMap(k3, z3));
        }
    ...
    private class SortedAsMap extends AbstractMapBasedMultimap<K, V>.AsMap implements SortedMap<K, Collection<V>> {
        ...
        public SortedMap<K, Collection<V>> headMap(@ParametricNullness K k3) {
            return new SortedAsMap(sortedMap().headMap(k3));
        }
        ...
        public SortedMap<K, Collection<V>> subMap(@ParametricNullness K k3, @ParametricNullness K k4) {
            return new SortedAsMap(sortedMap().subMap(k3, k4));
        }

        public SortedMap<K, Collection<V>> tailMap(@ParametricNullness K k3) {
            return new SortedAsMap(sortedMap().tailMap(k3));
        }
    }
    ...
    private class SortedKeySet extends AbstractMapBasedMultimap<K, V>.KeySet implements SortedSet<K> {
        ...
        public SortedSet<K> headSet(@ParametricNullness K k3) {
            return new SortedKeySet(sortedMap().headMap(k3));
        }
        ...
        public SortedSet<K> subSet(@ParametricNullness K k3, @ParametricNullness K k4) {
            return new SortedKeySet(sortedMap().subMap(k3, k4));
        }

        public SortedSet<K> tailSet(@ParametricNullness K k3) {
            return new SortedKeySet(sortedMap().tailMap(k3));
        }
    }
    ...
    class WrappedCollection extends AbstractCollection<V> {
        ...
        WrappedCollection(@ParametricNullness K k3, Collection<V> collection, @CheckForNull AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
            this.key = k3;
        ...
        public boolean add(@ParametricNullness V v3) {
            ...
            boolean add = this.delegate.add(v3);
            if (add) {
    ...
    class WrappedList extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements List<V> {
        ...
        private class WrappedListIterator extends AbstractMapBasedMultimap<K, V>.WrappedCollection.WrappedIterator implements ListIterator<V> {
            ...
            public void add(@ParametricNullness V v3) {
                ...
                getDelegateListIterator().add(v3);
                AbstractMapBasedMultimap.access$208(AbstractMapBasedMultimap.this);
                if (isEmpty) {
            ...
            public void set(@ParametricNullness V v3) {
                getDelegateListIterator().set(v3);
            }
        }
        ...
        @Override // java.util.List
        @ParametricNullness
        public V set(int i3, @ParametricNullness V v3) {
            refreshIfEmpty();
            return getListDelegate().set(i3, v3);
        }
        ...
        public List<V> subList(int i3, int i4) {
            refreshIfEmpty();
            return AbstractMapBasedMultimap.this.wrapList(getKey(), getListDelegate().subList(i3, i4), getAncestor() == null ? this : getAncestor());
        }
    }

    class WrappedNavigableSet extends AbstractMapBasedMultimap<K, V>.WrappedSortedSet implements NavigableSet<V> {
        WrappedNavigableSet(@ParametricNullness K k3, NavigableSet<V> navigableSet, @CheckForNull AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
        ...
        public V ceiling(@ParametricNullness V v3) {
            return getSortedSetDelegate().ceiling(v3);
        }
        ...
        public V floor(@ParametricNullness V v3) {
            return getSortedSetDelegate().floor(v3);
        }
        ...
        public NavigableSet<V> headSet(@ParametricNullness V v3, boolean z3) {
            return wrap(getSortedSetDelegate().headSet(v3, z3));
        }

        @Override // java.util.NavigableSet
        @CheckForNull
        public V higher(@ParametricNullness V v3) {
            return getSortedSetDelegate().higher(v3);
        }

        @Override // java.util.NavigableSet
        @CheckForNull
        public V lower(@ParametricNullness V v3) {
            return getSortedSetDelegate().lower(v3);
        }
        ...
        public NavigableSet<V> subSet(@ParametricNullness V v3, boolean z3, @ParametricNullness V v4, boolean z4) {
            return wrap(getSortedSetDelegate().subSet(v3, z3, v4, z4));
        }

        @Override // java.util.NavigableSet
        public NavigableSet<V> tailSet(@ParametricNullness V v3, boolean z3) {
            return wrap(getSortedSetDelegate().tailSet(v3, z3));
        }
    }

    class WrappedSet extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements Set<V> {
        WrappedSet(@ParametricNullness K k3, Set<V> set) {
            super(k3, set, null);
        }
    ...
    class WrappedSortedSet extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements SortedSet<V> {
        WrappedSortedSet(@ParametricNullness K k3, SortedSet<V> sortedSet, @CheckForNull AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
        ...
        public SortedSet<V> headSet(@ParametricNullness V v3) {
            refreshIfEmpty();
            return new WrappedSortedSet(getKey(), getSortedSetDelegate().headSet(v3), getAncestor() == null ? this : getAncestor());
        }
        ...
        public SortedSet<V> subSet(@ParametricNullness V v3, @ParametricNullness V v4) {
            refreshIfEmpty();
            return new WrappedSortedSet(getKey(), getSortedSetDelegate().subSet(v3, v4), getAncestor() == null ? this : getAncestor());
        }

        @Override // java.util.SortedSet
        public SortedSet<V> tailSet(@ParametricNullness V v3) {
            refreshIfEmpty();
            return new WrappedSortedSet(getKey(), getSortedSetDelegate().tailSet(v3), getAncestor() == null ? this : getAncestor());
        }
    }
    ...
    static /* synthetic */ int access$212(AbstractMapBasedMultimap abstractMapBasedMultimap, int i3) {
        int i4 = abstractMapBasedMultimap.totalSize + i3;
        abstractMapBasedMultimap.totalSize = i4;
        return i4;
    }

    static /* synthetic */ int access$220(AbstractMapBasedMultimap abstractMapBasedMultimap, int i3) {
        int i4 = abstractMapBasedMultimap.totalSize - i3;
        abstractMapBasedMultimap.totalSize = i4;
        return i4;
    }

    private Collection<V> getOrCreateCollection(@ParametricNullness K k3) {
        Collection<V> collection = this.map.get(k3);
        if (collection != null) {
            return collection;
        }
        Collection<V> createCollection = createCollection(k3);
    ...
    Collection<V> createCollection(@ParametricNullness K k3) {
        return createCollection();
    }
    ...
    Iterator<Map.Entry<K, V>> entryIterator() {
        return new AbstractMapBasedMultimap<K, V>.Itr<Map.Entry<K, V>>(this) { // from class: com.google.common.collect.AbstractMapBasedMultimap.2
            ...
            @Override // com.google.common.collect.AbstractMapBasedMultimap.Itr
            Map.Entry<K, V> output(@ParametricNullness K k3, @ParametricNullness V v3) {
                return Maps.immutableEntry(k3, v3);
            }
        };
    }
    ...
    public Collection<V> get(@ParametricNullness K k3) {
        Collection<V> collection = this.map.get(k3);
        if (collection == null) {
            collection = createCollection(k3);
        }
        return wrapCollection(k3, collection);
    }
    ...
    public Collection<V> replaceValues(@ParametricNullness K k3, Iterable<? extends V> iterable) {
        ...
        Collection<V> orCreateCollection = getOrCreateCollection(k3);
    ...
    Iterator<V> valueIterator() {
        return new AbstractMapBasedMultimap<K, V>.Itr<V>(this) { // from class: com.google.common.collect.AbstractMapBasedMultimap.1
            @Override // com.google.common.collect.AbstractMapBasedMultimap.Itr
            @ParametricNullness
            V output(@ParametricNullness K k3, @ParametricNullness V v3) {
                return v3;
            }
        };
    }
    ...
    final List<V> wrapList(@ParametricNullness K k3, List<V> list, @CheckForNull AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
