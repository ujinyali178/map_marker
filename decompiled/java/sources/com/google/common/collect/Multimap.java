...
public interface Multimap<K, V> {
    ...
    Collection<V> get(@ParametricNullness K k3);
    ...
    boolean put(@ParametricNullness K k3, @ParametricNullness V v3);

    boolean putAll(Multimap<? extends K, ? extends V> multimap);

    boolean putAll(@ParametricNullness K k3, Iterable<? extends V> iterable);

    boolean remove(@CheckForNull Object obj, @CheckForNull Object obj2);

    Collection<V> removeAll(@CheckForNull Object obj);

    Collection<V> replaceValues(@ParametricNullness K k3, Iterable<? extends V> iterable);
