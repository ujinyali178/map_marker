...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private static abstract class ArrayMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> {
        ...
        Iterator<Map.Entry<K, V>> entryIterator() {
            return new AbstractIndexedListIterator<Map.Entry<K, V>>(size()) { // from class: com.google.common.collect.ArrayTable.ArrayMap.2
                ...
                public Map.Entry<K, V> get(int i3) {
                    return ArrayMap.this.getEntry(i3);
                }
            };
        }
        ...
        Map.Entry<K, V> getEntry(final int i3) {
            Preconditions.checkElementIndex(i3, size());
            return new AbstractMapEntry<K, V>() { // from class: com.google.common.collect.ArrayTable.ArrayMap.1
                @Override // com.google.common.collect.AbstractMapEntry, java.util.Map.Entry
                public K getKey() {
                    return (K) ArrayMap.this.getKey(i3);
                }

                @Override // com.google.common.collect.AbstractMapEntry, java.util.Map.Entry
                @ParametricNullness
                public V getValue() {
                    return (V) ArrayMap.this.getValue(i3);
                }

                @Override // com.google.common.collect.AbstractMapEntry, java.util.Map.Entry
                @ParametricNullness
                public V setValue(@ParametricNullness V v3) {
                    return (V) ArrayMap.this.setValue(i3, v3);
                }
            };
        }

        K getKey(int i3) {
            return this.keyIndex.keySet().asList().get(i3);
        }
        ...
        public V put(K k3, @ParametricNullness V v3) {
            Integer num = this.keyIndex.get(k3);
            if (num != null) {
                return setValue(num.intValue(), v3);
            }
            throw new IllegalArgumentException(getKeyRole() + " " + k3 + " not in " + this.keyIndex.keySet());
        }
        ...
        @ParametricNullness
        abstract V setValue(int i3, @ParametricNullness V v3);
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        @CheckForNull
        V getValue(int i3) {
            return (V) ArrayTable.this.at(i3, this.columnIndex);
        }

        @Override // com.google.common.collect.ArrayTable.ArrayMap
        @CheckForNull
        V setValue(int i3, @CheckForNull V v3) {
            return (V) ArrayTable.this.set(i3, this.columnIndex, v3);
        }
    }
    ...
    private class ColumnMap extends ArrayMap<C, Map<R, V>> {
        ...
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        public Map<R, V> getValue(int i3) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        public Map<R, V> setValue(int i3, Map<R, V> map) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        @CheckForNull
        V getValue(int i3) {
            return (V) ArrayTable.this.at(this.rowIndex, i3);
        }

        @Override // com.google.common.collect.ArrayTable.ArrayMap
        @CheckForNull
        V setValue(int i3, @CheckForNull V v3) {
            return (V) ArrayTable.this.set(this.rowIndex, i3, v3);
        }
    }
    ...
    private class RowMap extends ArrayMap<R, Map<C, V>> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        public Map<C, V> getValue(int i3) {
            return new Row(i3);
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        public Map<C, V> setValue(int i3, Map<C, V> map) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    public Table.Cell<R, C, V> getCell(int i3) {
        return new Tables.AbstractCell<R, C, V>(i3) { // from class: com.google.common.collect.ArrayTable.2
            ...
            {
                this.val$index = i3;
                this.rowIndex = i3 / ArrayTable.this.columnList.size();
                this.columnIndex = i3 % ArrayTable.this.columnList.size();
            }
    ...
    public V getValue(int i3) {
        return at(i3 / this.columnList.size(), i3 % this.columnList.size());
    }

    @CheckForNull
    public V at(int i3, int i4) {
        Preconditions.checkElementIndex(i3, this.rowList.size());
        Preconditions.checkElementIndex(i4, this.columnList.size());
        return this.array[i3][i4];
    }
    ...
    Iterator<Table.Cell<R, C, V>> cellIterator() {
        return new AbstractIndexedListIterator<Table.Cell<R, C, V>>(size()) { // from class: com.google.common.collect.ArrayTable.1
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.google.common.collect.AbstractIndexedListIterator
            public Table.Cell<R, C, V> get(int i3) {
                return ArrayTable.this.getCell(i3);
            }
        };
    }
    ...
    @Override // com.google.common.collect.AbstractTable, com.google.common.collect.Table
    @CheckForNull
    public V put(R r3, C c3, @CheckForNull V v3) {
    ...
    Iterator<V> valuesIterator() {
        return new AbstractIndexedListIterator<V>(size()) { // from class: com.google.common.collect.ArrayTable.3
            @Override // com.google.common.collect.AbstractIndexedListIterator
            @CheckForNull
            protected V get(int i3) {
                return (V) ArrayTable.this.getValue(i3);
            }
        };
    }
}
