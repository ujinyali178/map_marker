...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    public ImmutableSortedSet<E> headSet(E e3, boolean z3) {
        return headSetImpl(Preconditions.checkNotNull(e3), z3);
    }
    ...
    abstract ImmutableSortedSet<E> headSetImpl(E e3, boolean z3);
    ...
    public ImmutableSortedSet<E> subSet(E e3, E e4) {
        return subSet((boolean) e3, true, (boolean) e4, false);
    }

    public ImmutableSortedSet<E> subSet(E e3, boolean z3, E e4, boolean z4) {
        Preconditions.checkNotNull(e3);
        Preconditions.checkNotNull(e4);
        Preconditions.checkArgument(this.comparator.compare(e3, e4) <= 0);
        return subSetImpl(e3, z3, e4, z4);
    }
    ...
    abstract ImmutableSortedSet<E> subSetImpl(E e3, boolean z3, E e4, boolean z4);
    ...
    public ImmutableSortedSet<E> tailSet(E e3, boolean z3) {
        return tailSetImpl(Preconditions.checkNotNull(e3), z3);
    }
    ...
    abstract ImmutableSortedSet<E> tailSetImpl(E e3, boolean z3);
