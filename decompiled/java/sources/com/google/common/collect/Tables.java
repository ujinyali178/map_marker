...
public final class Tables {
    ...
    static final class ImmutableCell<R, C, V> extends AbstractCell<R, C, V> implements Serializable {
        ...
        ImmutableCell(@ParametricNullness R r3, @ParametricNullness C c3, @ParametricNullness V v3) {
            this.rowKey = r3;
            this.columnKey = c3;
            this.value = v3;
        }
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        public Map<R, V2> column(@ParametricNullness C c3) {
        ...
        @Override // com.google.common.collect.AbstractTable, com.google.common.collect.Table
        @CheckForNull
        public V2 put(@ParametricNullness R r3, @ParametricNullness C c3, @ParametricNullness V2 v22) {
        ...
        @Override // com.google.common.collect.Table
        public Map<C, V2> row(@ParametricNullness R r3) {
            return Maps.transformValues(this.fromTable.row(r3), this.function);
        }
    ...
    private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        ...
        @Override // com.google.common.collect.Table
        public Map<C, V> column(@ParametricNullness R r3) {
            return this.original.row(r3);
        }
        ...
        @Override // com.google.common.collect.AbstractTable, com.google.common.collect.Table
        @CheckForNull
        public V put(@ParametricNullness C c3, @ParametricNullness R r3, @ParametricNullness V v3) {
            return this.original.put(r3, c3, v3);
        }
        ...
        @Override // com.google.common.collect.Table
        public Map<R, V> row(@ParametricNullness C c3) {
    ...
    public static <R, C, V> Table.Cell<R, C, V> immutableCell(@ParametricNullness R r3, @ParametricNullness C c3, @ParametricNullness V v3) {
