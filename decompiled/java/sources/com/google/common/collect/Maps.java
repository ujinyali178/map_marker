...
public final class Maps {
    ...
    private static abstract class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        boolean apply(@CheckForNull Object obj, @ParametricNullness V v3) {
            return this.predicate.apply(Maps.immutableEntry(obj, v3));
        }
        ...
        public V get(@CheckForNull Object obj) {
            V v3 = this.unfiltered.get(obj);
            if (v3 == null || !apply(obj, v3)) {
                return null;
            }
            return v3;
        }
        ...
        public V put(@ParametricNullness K k3, @ParametricNullness V v3) {
            Preconditions.checkArgument(apply(k3, v3));
            return this.unfiltered.put(k3, v3);
        }
    ...
    static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> {
        ...
        public Map.Entry<K, V> ceilingEntry(@ParametricNullness K k3) {
            return forward().floorEntry(k3);
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K ceilingKey(@ParametricNullness K k3) {
            return forward().floorKey(k3);
        }
        ...
        public Map.Entry<K, V> floorEntry(@ParametricNullness K k3) {
            return forward().ceilingEntry(k3);
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K floorKey(@ParametricNullness K k3) {
            return forward().ceilingKey(k3);
        }
        ...
        public NavigableMap<K, V> headMap(@ParametricNullness K k3, boolean z3) {
            return forward().tailMap(k3, z3).descendingMap();
        }
        ...
        public Map.Entry<K, V> higherEntry(@ParametricNullness K k3) {
            return forward().lowerEntry(k3);
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K higherKey(@ParametricNullness K k3) {
            return forward().lowerKey(k3);
        }
        ...
        public Map.Entry<K, V> lowerEntry(@ParametricNullness K k3) {
            return forward().higherEntry(k3);
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K lowerKey(@ParametricNullness K k3) {
            return forward().higherKey(k3);
        }
        ...
        public NavigableMap<K, V> subMap(@ParametricNullness K k3, boolean z3, @ParametricNullness K k4, boolean z4) {
            return forward().subMap(k4, z4, k3, z3).descendingMap();
        }
        ...
        public NavigableMap<K, V> tailMap(@ParametricNullness K k3, boolean z3) {
            return forward().headMap(k3, z3).descendingMap();
        }
    ...
    public interface EntryTransformer<K, V1, V2> {
        @ParametricNullness
        V2 transformEntry(@ParametricNullness K k3, @ParametricNullness V1 v12);
    }
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        public V forcePut(@ParametricNullness K k3, @ParametricNullness V v3) {
            Preconditions.checkArgument(apply(k3, v3));
            return unfiltered().forcePut(k3, v3);
        }
                    ...
                    public Map.Entry<K, V> transform(final Map.Entry<K, V> entry) {
                        return new ForwardingMapEntry<K, V>() { // from class: com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1.1
                            ...
                            public V setValue(@ParametricNullness V v3) {
                                Preconditions.checkArgument(FilteredEntryMap.this.apply(getKey(), v3));
    ...
    private static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(@ParametricNullness K k3, boolean z3) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.headMap(k3, z3), (Predicate) this.entryPredicate);
        }
        ...
        @CheckForNull
        public V put(@ParametricNullness K k3, @ParametricNullness V v3) {
            return this.filteredDelegate.put(k3, v3);
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(@ParametricNullness K k3, boolean z3, @ParametricNullness K k4, boolean z4) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.subMap(k3, z3, k4, z4), (Predicate) this.entryPredicate);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(@ParametricNullness K k3, boolean z3) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.tailMap(k3, z3), (Predicate) this.entryPredicate);
        }
    ...
    private static class FilteredEntrySortedMap<K, V> extends FilteredEntryMap<K, V> implements SortedMap<K, V> {
        ...
        class SortedKeySet extends FilteredEntryMap<K, V>.KeySet implements SortedSet<K> {
            ...
            public SortedSet<K> headSet(@ParametricNullness K k3) {
                return (SortedSet) FilteredEntrySortedMap.this.headMap(k3).keySet();
            }
            ...
            public SortedSet<K> subSet(@ParametricNullness K k3, @ParametricNullness K k4) {
                return (SortedSet) FilteredEntrySortedMap.this.subMap(k3, k4).keySet();
            }

            @Override // java.util.SortedSet
            public SortedSet<K> tailSet(@ParametricNullness K k3) {
                return (SortedSet) FilteredEntrySortedMap.this.tailMap(k3).keySet();
            }
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> headMap(@ParametricNullness K k3) {
            return new FilteredEntrySortedMap(sortedMap().headMap(k3), this.predicate);
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> subMap(@ParametricNullness K k3, @ParametricNullness K k4) {
            return new FilteredEntrySortedMap(sortedMap().subMap(k3, k4), this.predicate);
        }

        @Override // java.util.SortedMap
        public SortedMap<K, V> tailMap(@ParametricNullness K k3) {
            return new FilteredEntrySortedMap(sortedMap().tailMap(k3), this.predicate);
        }
    }
    ...
    private static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V> {
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(@ParametricNullness K k3, boolean z3) {
            return Maps.asMap((NavigableSet) this.set.headSet(k3, z3), (Function) this.function);
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(@ParametricNullness K k3, boolean z3, @ParametricNullness K k4, boolean z4) {
            return Maps.asMap((NavigableSet) this.set.subSet(k3, z3, k4, z4), (Function) this.function);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(@ParametricNullness K k3, boolean z3) {
            return Maps.asMap((NavigableSet) this.set.tailSet(k3, z3), (Function) this.function);
        }
    }
    ...
    static class NavigableKeySet<K, V> extends SortedKeySet<K, V> implements NavigableSet<K> {
        ...
        public K higher(@ParametricNullness K k3) {
            return map().higherKey(k3);
        }

        @Override // java.util.NavigableSet
        @CheckForNull
        public K lower(@ParametricNullness K k3) {
            return map().lowerKey(k3);
        }
        ...
        public NavigableSet<K> subSet(@ParametricNullness K k3, boolean z3, @ParametricNullness K k4, boolean z4) {
            return map().subMap(k3, z3, k4, z4).navigableKeySet();
        }
        ...
        public NavigableSet<K> tailSet(@ParametricNullness K k3, boolean z3) {
            return map().tailMap(k3, z3).navigableKeySet();
        }
    ...
    private static class SortedAsMapView<K, V> extends AsMapView<K, V> implements SortedMap<K, V> {
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> headMap(@ParametricNullness K k3) {
            return Maps.asMap((SortedSet) backingSet().headSet(k3), (Function) this.function);
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> subMap(@ParametricNullness K k3, @ParametricNullness K k4) {
            return Maps.asMap((SortedSet) backingSet().subSet(k3, k4), (Function) this.function);
        }

        @Override // java.util.SortedMap
        public SortedMap<K, V> tailMap(@ParametricNullness K k3) {
            return Maps.asMap((SortedSet) backingSet().tailSet(k3), (Function) this.function);
        }
    }
    ...
    static class SortedKeySet<K, V> extends KeySet<K, V> implements SortedSet<K> {
        ...
        public SortedSet<K> headSet(@ParametricNullness K k3) {
            return new SortedKeySet(map().headMap(k3));
        }
        ...
        public SortedSet<K> subSet(@ParametricNullness K k3, @ParametricNullness K k4) {
            return new SortedKeySet(map().subMap(k3, k4));
        }

        public SortedSet<K> tailSet(@ParametricNullness K k3) {
            return new SortedKeySet(map().tailMap(k3));
        }
    }
    ...
    private static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2> {
        ...
        @Override // java.util.NavigableMap
        @CheckForNull
        public Map.Entry<K, V2> ceilingEntry(@ParametricNullness K k3) {
            return transformEntry(fromMap().ceilingEntry(k3));
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K ceilingKey(@ParametricNullness K k3) {
            return fromMap().ceilingKey(k3);
        }
        ...
        @Override // java.util.NavigableMap
        @CheckForNull
        public Map.Entry<K, V2> floorEntry(@ParametricNullness K k3) {
            return transformEntry(fromMap().floorEntry(k3));
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K floorKey(@ParametricNullness K k3) {
            return fromMap().floorKey(k3);
        }
        ...
        public NavigableMap<K, V2> headMap(@ParametricNullness K k3) {
            return headMap(k3, false);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V2> headMap(@ParametricNullness K k3, boolean z3) {
            return Maps.transformEntries((NavigableMap) fromMap().headMap(k3, z3), (EntryTransformer) this.transformer);
        }
        ...
        @Override // java.util.NavigableMap
        @CheckForNull
        public Map.Entry<K, V2> higherEntry(@ParametricNullness K k3) {
            return transformEntry(fromMap().higherEntry(k3));
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K higherKey(@ParametricNullness K k3) {
            return fromMap().higherKey(k3);
        }
        ...
        @Override // java.util.NavigableMap
        @CheckForNull
        public Map.Entry<K, V2> lowerEntry(@ParametricNullness K k3) {
            return transformEntry(fromMap().lowerEntry(k3));
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K lowerKey(@ParametricNullness K k3) {
            return fromMap().lowerKey(k3);
        }
        ...
        @Override // com.google.common.collect.Maps.TransformedEntriesSortedMap, java.util.SortedMap, java.util.NavigableMap
        public NavigableMap<K, V2> subMap(@ParametricNullness K k3, @ParametricNullness K k4) {
            return subMap(k3, true, k4, false);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V2> subMap(@ParametricNullness K k3, boolean z3, @ParametricNullness K k4, boolean z4) {
            return Maps.transformEntries((NavigableMap) fromMap().subMap(k3, z3, k4, z4), (EntryTransformer) this.transformer);
        }

        @Override // com.google.common.collect.Maps.TransformedEntriesSortedMap, java.util.SortedMap, java.util.NavigableMap
        public NavigableMap<K, V2> tailMap(@ParametricNullness K k3) {
            return tailMap(k3, true);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V2> tailMap(@ParametricNullness K k3, boolean z3) {
            return Maps.transformEntries((NavigableMap) fromMap().tailMap(k3, z3), (EntryTransformer) this.transformer);
        }
    ...
    static class TransformedEntriesSortedMap<K, V1, V2> extends TransformedEntriesMap<K, V1, V2> implements SortedMap<K, V2> {
        ...
        public SortedMap<K, V2> headMap(@ParametricNullness K k3) {
            return Maps.transformEntries((SortedMap) fromMap().headMap(k3), (EntryTransformer) this.transformer);
        }
        ...
        public SortedMap<K, V2> subMap(@ParametricNullness K k3, @ParametricNullness K k4) {
            return Maps.transformEntries((SortedMap) fromMap().subMap(k3, k4), (EntryTransformer) this.transformer);
        }

        public SortedMap<K, V2> tailMap(@ParametricNullness K k3) {
            return Maps.transformEntries((SortedMap) fromMap().tailMap(k3), (EntryTransformer) this.transformer);
        }
    }
    ...
    static class UnmodifiableNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V>, Serializable {
        ...
        @CheckForNull
        public Map.Entry<K, V> ceilingEntry(@ParametricNullness K k3) {
            return Maps.unmodifiableOrNull(this.delegate.ceilingEntry(k3));
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K ceilingKey(@ParametricNullness K k3) {
            return this.delegate.ceilingKey(k3);
        }
        ...
        @CheckForNull
        public Map.Entry<K, V> floorEntry(@ParametricNullness K k3) {
            return Maps.unmodifiableOrNull(this.delegate.floorEntry(k3));
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K floorKey(@ParametricNullness K k3) {
            return this.delegate.floorKey(k3);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(@ParametricNullness K k3, boolean z3) {
            return Maps.unmodifiableNavigableMap(this.delegate.headMap(k3, z3));
        }
        ...
        @CheckForNull
        public Map.Entry<K, V> higherEntry(@ParametricNullness K k3) {
            return Maps.unmodifiableOrNull(this.delegate.higherEntry(k3));
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K higherKey(@ParametricNullness K k3) {
            return this.delegate.higherKey(k3);
        }
        ...
        @CheckForNull
        public Map.Entry<K, V> lowerEntry(@ParametricNullness K k3) {
            return Maps.unmodifiableOrNull(this.delegate.lowerEntry(k3));
        }

        @Override // java.util.NavigableMap
        @CheckForNull
        public K lowerKey(@ParametricNullness K k3) {
            return this.delegate.lowerKey(k3);
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(@ParametricNullness K k3, boolean z3, @ParametricNullness K k4, boolean z4) {
            return Maps.unmodifiableNavigableMap(this.delegate.subMap(k3, z3, k4, z4));
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(@ParametricNullness K k3, boolean z3) {
            return Maps.unmodifiableNavigableMap(this.delegate.tailMap(k3, z3));
        }
    ...
    static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        static <V> MapDifference.ValueDifference<V> create(@ParametricNullness V v3, @ParametricNullness V v4) {
    ...
    static <K, V1, V2> EntryTransformer<K, V1, V2> asEntryTransformer(final Function<? super V1, V2> function) {
        ...
        return new EntryTransformer<K, V1, V2>() { // from class: com.google.common.collect.Maps.9
            ...
            @ParametricNullness
            public V2 transformEntry(@ParametricNullness K k3, @ParametricNullness V1 v12) {
    ...
    static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.common.collect.Maps.3
            ...
            @Override // com.google.common.collect.TransformedIterator
            Map.Entry<K, V> transform(@ParametricNullness K k3) {
                return Maps.immutableEntry(k3, function.apply(k3));
            }
        };
    }

    static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> entryTransformer, @ParametricNullness final K k3) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<V1, V2>() { // from class: com.google.common.collect.Maps.10
            @Override // com.google.common.base.Function
            @ParametricNullness
            public V2 apply(@ParametricNullness V1 v12) {
                return (V2) EntryTransformer.this.transformEntry(k3, v12);
            }
        };
    }

    static int capacity(int i3) {
        if (i3 < 3) {
    ...
    private static <K, V> void doDifference(Map<? extends K, ? extends V> map, Map<? extends K, ? extends V> map2, Equivalence<? super V> equivalence, Map<K, V> map3, Map<K, V> map4, Map<K, V> map5, Map<K, MapDifference.ValueDifference<V>> map6) {
        for (Map.Entry<? extends K, ? extends V> entry : map.entrySet()) {
            ...
            if (map2.containsKey(key)) {
                a2.c cVar = (Object) NullnessCasts.uncheckedCastNullableTToT(map4.remove(key));
                if (equivalence.equivalent(value, cVar)) {
                    map5.put(key, value);
                } else {
                    map6.put(key, ValueDifferenceImpl.create(value, cVar));
                }
            } else {
                map3.put(key, value);
            }
    ...
    public static <K, V> Map.Entry<K, V> immutableEntry(@ParametricNullness K k3, @ParametricNullness V v3) {
    ...
    static String toStringImpl(Map<?, ?> map) {
        ...
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            ...
            newStringBuilderForCollection.append(Tag.KEY_VALUE_SEPARATOR);
