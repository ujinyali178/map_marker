...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            if (peekingIterator.hasNext()) {
                ...
                belowAll = ((Range) peekingIterator.peek()).upperBound;
            } else {
        ...
        public NavigableMap<Cut<C>, Range<C>> headMap(Cut<C> cut, boolean z3) {
            return subMap(Range.upTo(cut, BoundType.forBoolean(z3)));
        }
        ...
        public NavigableMap<Cut<C>, Range<C>> subMap(Cut<C> cut, boolean z3, Cut<C> cut2, boolean z4) {
            return subMap(Range.range(cut, BoundType.forBoolean(z3), cut2, BoundType.forBoolean(z4)));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<Cut<C>, Range<C>> tailMap(Cut<C> cut, boolean z3) {
            return subMap(Range.downTo(cut, BoundType.forBoolean(z3)));
        }
    }
    ...
    static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            final Iterator<Range<C>> it = ((this.upperBoundWindow.hasLowerBound() && (lowerEntry = this.rangesByLowerBound.lowerEntry(this.upperBoundWindow.lowerEndpoint())) != null) ? this.upperBoundWindow.lowerBound.isLessThan(lowerEntry.getValue().upperBound) ? this.rangesByLowerBound.tailMap(lowerEntry.getKey(), true) : this.rangesByLowerBound.tailMap(this.upperBoundWindow.lowerEndpoint(), true) : this.rangesByLowerBound).values().iterator();
    ...
    private static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            if (!this.restriction.isEmpty() && !this.lowerBoundWindow.upperBound.isLessThan(this.restriction.lowerBound)) {
                ...
                final Iterator<Range<C>> it = navigableMap.tailMap(endpoint, z3).values().iterator();
