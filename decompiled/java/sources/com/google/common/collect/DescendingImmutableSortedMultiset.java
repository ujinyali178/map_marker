...
final class DescendingImmutableSortedMultiset<E> extends ImmutableSortedMultiset<E> {
    ...
    public ImmutableSortedMultiset<E> headMultiset(E e3, BoundType boundType) {
        return this.forward.tailMultiset((ImmutableSortedMultiset<E>) e3, boundType).descendingMultiset();
    }
    ...
    public ImmutableSortedMultiset<E> tailMultiset(E e3, BoundType boundType) {
        return this.forward.headMultiset((ImmutableSortedMultiset<E>) e3, boundType).descendingMultiset();
    }
