...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    private final class CellSet extends IndexedImmutableSet<Table.Cell<R, C, V>> {
        ...
        public Table.Cell<R, C, V> get(int i3) {
            return RegularImmutableTable.this.getCell(i3);
        }
    ...
    private final class Values extends ImmutableList<V> {
        ...
        public V get(int i3) {
            return (V) RegularImmutableTable.this.getValue(i3);
        }
    ...
    static <R, C, V> RegularImmutableTable<R, C, V> forCells(List<Table.Cell<R, C, V>> list, @CheckForNull final Comparator<? super R> comparator, @CheckForNull final Comparator<? super C> comparator2) {
        ...
        if (comparator != null || comparator2 != null) {
            Collections.sort(list, new Comparator() { // from class: com.google.common.collect.k
    ...
    final void checkNoDuplicate(R r3, C c3, @CheckForNull V v3, V v4) {
        Preconditions.checkArgument(v3 == null, "Duplicate key: (row=%s, column=%s), values: [%s, %s].", r3, c3, v4, v3);
    }
    ...
    abstract Table.Cell<R, C, V> getCell(int i3);
