...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public static final class Builder<R, C, V> {
        ...
        public Builder<R, C, V> put(R r3, C c3, V v3) {
            this.cells.add(ImmutableTable.cellOf(r3, c3, v3));
            return this;
        }
    ...
    static final class SerializedForm implements Serializable {
        ...
        Object readResolve() {
            ...
            while (true) {
                ...
                builder.add((ImmutableList.Builder) ImmutableTable.cellOf(this.rowKeys[this.cellRowIndices[i3]], this.columnKeys[this.cellColumnIndices[i3]], objArr2[i3]));
                i3++;
            }
        }
    }
    ...
    static <R, C, V> Table.Cell<R, C, V> cellOf(R r3, C c3, V v3) {
        return Tables.immutableCell(Preconditions.checkNotNull(r3, "rowKey"), Preconditions.checkNotNull(c3, "columnKey"), Preconditions.checkNotNull(v3, "value"));
    }
    ...
    public static <R, C, V> ImmutableTable<R, C, V> of(R r3, C c3, V v3) {
    ...
    @CheckForNull
    @Deprecated
    public final V put(R r3, C c3, V v3) {
        throw new UnsupportedOperationException();
    }
    ...
    public ImmutableMap<C, V> row(R r3) {
        Preconditions.checkNotNull(r3, "rowKey");
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(r3), ImmutableMap.of());
    }
