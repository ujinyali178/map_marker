...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    ...
    public E ceiling(E e3) {
        int tailIndex = tailIndex(e3, true);
        if (tailIndex == size()) {
            return null;
        }
    ...
    @CheckForNull
    public E floor(E e3) {
        int headIndex = headIndex(e3, true) - 1;
        if (headIndex == -1) {
            return null;
        }
    ...
    RegularImmutableSortedSet<E> getSubSet(int i3, int i4) {
        return (i3 == 0 && i4 == size()) ? this : i3 < i4 ? new RegularImmutableSortedSet<>(this.elements.subList(i3, i4), this.comparator) : ImmutableSortedSet.emptySet(this.comparator);
    }

    int headIndex(E e3, boolean z3) {
        int binarySearch = Collections.binarySearch(this.elements, Preconditions.checkNotNull(e3), comparator());
        return binarySearch >= 0 ? z3 ? binarySearch + 1 : binarySearch : ~binarySearch;
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    ImmutableSortedSet<E> headSetImpl(E e3, boolean z3) {
        return getSubSet(0, headIndex(e3, z3));
    }

    @Override // com.google.common.collect.ImmutableSortedSet, java.util.NavigableSet
    @CheckForNull
    public E higher(E e3) {
        int tailIndex = tailIndex(e3, false);
        if (tailIndex == size()) {
            return null;
        }
        return this.elements.get(tailIndex);
    ...
    @CheckForNull
    public E lower(E e3) {
        int headIndex = headIndex(e3, false) - 1;
        if (headIndex == -1) {
            return null;
        }
        return this.elements.get(headIndex);
    ...
    ImmutableSortedSet<E> subSetImpl(E e3, boolean z3, E e4, boolean z4) {
        return tailSetImpl(e3, z3).headSetImpl(e4, z4);
    }

    int tailIndex(E e3, boolean z3) {
        int binarySearch = Collections.binarySearch(this.elements, Preconditions.checkNotNull(e3), comparator());
    ...
    ImmutableSortedSet<E> tailSetImpl(E e3, boolean z3) {
        return getSubSet(tailIndex(e3, z3), size());
    }
