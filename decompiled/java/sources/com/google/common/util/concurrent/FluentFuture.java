...
public abstract class FluentFuture<V> extends GwtFluentFutureCatchingSpecialization<V> {
    ...
    public final FluentFuture<V> withTimeout(long j3, TimeUnit timeUnit, ScheduledExecutorService scheduledExecutorService) {
        return (FluentFuture) Futures.withTimeout(this, j3, timeUnit, scheduledExecutorService);
    }
}
