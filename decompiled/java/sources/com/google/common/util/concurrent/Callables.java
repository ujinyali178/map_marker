...
public final class Callables {
    ...
    public static <T> AsyncCallable<T> asAsyncCallable(final Callable<T> callable, final ListeningExecutorService listeningExecutorService) {
        ...
        return new AsyncCallable() { // from class: com.google.common.util.concurrent.p
    ...
    public static <T> Callable<T> returning(@ParametricNullness final T t3) {
        return new Callable() { // from class: com.google.common.util.concurrent.m
            ...
            public final Object call() {
                ...
                lambda$returning$0 = Callables.lambda$returning$0(t3);
    ...
    static Runnable threadRenaming(final Runnable runnable, final Supplier<String> supplier) {
        ...
        return new Runnable() { // from class: com.google.common.util.concurrent.n
