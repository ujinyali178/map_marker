...
abstract class WrappingExecutorService implements ExecutorService {
    ...
    public final <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> collection, long j3, TimeUnit timeUnit) {
        return this.delegate.invokeAll(wrapTasks(collection), j3, timeUnit);
    }
    ...
    public final <T> T invokeAny(Collection<? extends Callable<T>> collection, long j3, TimeUnit timeUnit) {
        return (T) this.delegate.invokeAny(wrapTasks(collection), j3, timeUnit);
    }
    ...
    public final <T> Future<T> submit(Runnable runnable, @ParametricNullness T t3) {
        return this.delegate.submit(wrapTask(runnable), t3);
    }
