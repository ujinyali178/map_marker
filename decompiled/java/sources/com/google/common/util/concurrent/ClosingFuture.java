...
public final class ClosingFuture<V> {
    ...
    public interface AsyncClosingFunction<T, U> {
        ClosingFuture<U> apply(DeferredCloser deferredCloser, @ParametricNullness T t3);
    }
    ...
    private static final class CloseableList extends IdentityHashMap<Closeable, Executor> implements Closeable {
        ...
        <V, U> FluentFuture<U> applyAsyncClosingFunction(AsyncClosingFunction<V, U> asyncClosingFunction, @ParametricNullness V v3) {
        ...
        <V, U> ListenableFuture<U> applyClosingFunction(ClosingFunction<? super V, U> closingFunction, @ParametricNullness V v3) {
            CloseableList closeableList = new CloseableList();
            try {
    ...
    public interface ClosingFunction<T, U> {
        @ParametricNullness
        U apply(DeferredCloser deferredCloser, @ParametricNullness T t3);
    }
    ...
    public static class Combiner {
        ...
        private ImmutableList<FluentFuture<?>> inputFutures() {
            return FluentIterable.from(this.inputs).transform(new Function() { // from class: com.google.common.util.concurrent.r
    ...
    public static final class Combiner3<V1, V2, V3> extends Combiner {
        ...
        public interface AsyncClosingFunction3<V1, V2, V3, U> {
            ClosingFuture<U> apply(DeferredCloser deferredCloser, @ParametricNullness V1 v12, @ParametricNullness V2 v22, @ParametricNullness V3 v3);
        }

        public interface ClosingFunction3<V1, V2, V3, U> {
            @ParametricNullness
            U apply(DeferredCloser deferredCloser, @ParametricNullness V1 v12, @ParametricNullness V2 v22, @ParametricNullness V3 v3);
        }
    ...
    public static final class Combiner4<V1, V2, V3, V4> extends Combiner {
        ...
        public interface AsyncClosingFunction4<V1, V2, V3, V4, U> {
            ClosingFuture<U> apply(DeferredCloser deferredCloser, @ParametricNullness V1 v12, @ParametricNullness V2 v22, @ParametricNullness V3 v3, @ParametricNullness V4 v4);
        }

        public interface ClosingFunction4<V1, V2, V3, V4, U> {
            @ParametricNullness
            U apply(DeferredCloser deferredCloser, @ParametricNullness V1 v12, @ParametricNullness V2 v22, @ParametricNullness V3 v3, @ParametricNullness V4 v4);
        }
    ...
    public static final class Combiner5<V1, V2, V3, V4, V5> extends Combiner {
        ...
        public interface AsyncClosingFunction5<V1, V2, V3, V4, V5, U> {
            ClosingFuture<U> apply(DeferredCloser deferredCloser, @ParametricNullness V1 v12, @ParametricNullness V2 v22, @ParametricNullness V3 v3, @ParametricNullness V4 v4, @ParametricNullness V5 v5);
        }

        public interface ClosingFunction5<V1, V2, V3, V4, V5, U> {
            @ParametricNullness
            U apply(DeferredCloser deferredCloser, @ParametricNullness V1 v12, @ParametricNullness V2 v22, @ParametricNullness V3 v3, @ParametricNullness V4 v4, @ParametricNullness V5 v5);
        }
    ...
    public static final class DeferredCloser {
        ...
        @ParametricNullness
        public <C extends Closeable> C eventuallyClose(@ParametricNullness C c3, Executor executor) {
            Preconditions.checkNotNull(executor);
            if (c3 != null) {
                this.list.add(c3, executor);
            }
            return c3;
        }
    }
    ...
    public static void closeQuietly(@CheckForNull final Closeable closeable, Executor executor) {
        ...
        try {
            ...
            if (logger2.isLoggable(level)) {
                logger2.log(level, String.format("while submitting close to %s; will close inline", executor), (Throwable) e3);
            }
    ...
    private boolean compareAndUpdateState(State state, State state2) {
        return com.google.android.gms.common.api.internal.a.a(this.state, state, state2);
    }
    ...
    public static /* synthetic */ void lambda$closeQuietly$0(Closeable closeable) {
        try {
            ...
            logger.log(Level.WARNING, "thrown by close()", e3);
        }
    }
    ...
    public static <V, U> AsyncClosingFunction<V, U> withoutCloser(final AsyncFunction<V, U> asyncFunction) {
        ...
        return new AsyncClosingFunction<V, U>() { // from class: com.google.common.util.concurrent.ClosingFuture.6
            ...
            public ClosingFuture<U> apply(DeferredCloser deferredCloser, V v3) {
    ...
    public void finishToValueAndCloser(final ValueAndCloserConsumer<? super V> valueAndCloserConsumer, Executor executor) {
        ...
        int i3 = AnonymousClass11.$SwitchMap$com$google$common$util$concurrent$ClosingFuture$State[this.state.get().ordinal()];
        if (i3 == 1) {
    ...
    public <U> ClosingFuture<U> transform(final ClosingFunction<? super V, U> closingFunction, Executor executor) {
        ...
        return derive(this.future.transformAsync(new AsyncFunction<V, U>() { // from class: com.google.common.util.concurrent.ClosingFuture.4
            @Override // com.google.common.util.concurrent.AsyncFunction
            public ListenableFuture<U> apply(V v3) {
                return ClosingFuture.this.closeables.applyClosingFunction(closingFunction, v3);
            }
    ...
    public <U> ClosingFuture<U> transformAsync(final AsyncClosingFunction<? super V, U> asyncClosingFunction, Executor executor) {
        ...
        return derive(this.future.transformAsync(new AsyncFunction<V, U>() { // from class: com.google.common.util.concurrent.ClosingFuture.5
            @Override // com.google.common.util.concurrent.AsyncFunction
            public ListenableFuture<U> apply(V v3) {
                return ClosingFuture.this.closeables.applyAsyncClosingFunction(asyncClosingFunction, v3);
            }
