...
public final class ServiceManager implements ServiceManagerBridge {
    ...
    private static final class ServiceManagerState {
        ...
        void awaitHealthy(long j3, TimeUnit timeUnit) {
            this.monitor.enter();
            try {
                if (this.monitor.waitForUninterruptibly(this.awaitHealthGuard, j3, timeUnit)) {
                    checkHealthy();
                    return;
                }
        ...
        void awaitStopped(long j3, TimeUnit timeUnit) {
            this.monitor.enter();
            try {
                if (this.monitor.waitForUninterruptibly(this.stoppedGuard, j3, timeUnit)) {
                    return;
                }
    ...
    public void awaitHealthy(long j3, TimeUnit timeUnit) {
        this.state.awaitHealthy(j3, timeUnit);
    }
    ...
    public void awaitStopped(long j3, TimeUnit timeUnit) {
        this.state.awaitStopped(j3, timeUnit);
    }
    ...
    public ServiceManager startAsync() {
        ...
        while (it2.hasNext()) {
            ...
            try {
                ...
                logger.log(Level.WARNING, "Unable to start Service " + next, (Throwable) e3);
            }
        }
        return this;
    }
