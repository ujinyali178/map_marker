...
final class TimeoutFuture<V> extends FluentFuture.TrustedFuture<V> {
    ...
    static <V> ListenableFuture<V> create(ListenableFuture<V> listenableFuture, long j3, TimeUnit timeUnit, ScheduledExecutorService scheduledExecutorService) {
        TimeoutFuture timeoutFuture = new TimeoutFuture(listenableFuture);
        Fire fire = new Fire(timeoutFuture);
        timeoutFuture.timer = scheduledExecutorService.schedule(fire, j3, timeUnit);
