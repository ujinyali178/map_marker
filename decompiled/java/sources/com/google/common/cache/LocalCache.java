...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static abstract class EntryFactory {
        STRONG { // from class: com.google.common.cache.LocalCache.EntryFactory.1
            ...
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
                return new StrongEntry(k3, i3, referenceEntry);
            }
        },
        STRONG_ACCESS { // from class: com.google.common.cache.LocalCache.EntryFactory.2
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> copyEntry(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, ReferenceEntry<K, V> referenceEntry2, K k3) {
                ReferenceEntry<K, V> copyEntry = super.copyEntry(segment, referenceEntry, referenceEntry2, k3);
            ...
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
                return new StrongAccessEntry(k3, i3, referenceEntry);
            }
        },
        STRONG_WRITE { // from class: com.google.common.cache.LocalCache.EntryFactory.3
            ...
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
                return new StrongWriteEntry(k3, i3, referenceEntry);
            }
        },
        STRONG_ACCESS_WRITE { // from class: com.google.common.cache.LocalCache.EntryFactory.4
            ...
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
                return new StrongAccessWriteEntry(k3, i3, referenceEntry);
            }
        },
        WEAK { // from class: com.google.common.cache.LocalCache.EntryFactory.5
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
                return new WeakEntry(segment.keyReferenceQueue, k3, i3, referenceEntry);
            }
        },
        WEAK_ACCESS { // from class: com.google.common.cache.LocalCache.EntryFactory.6
            ...
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
                return new WeakAccessEntry(segment.keyReferenceQueue, k3, i3, referenceEntry);
            }
        },
        WEAK_WRITE { // from class: com.google.common.cache.LocalCache.EntryFactory.7
            ...
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
                return new WeakWriteEntry(segment.keyReferenceQueue, k3, i3, referenceEntry);
            }
        },
        WEAK_ACCESS_WRITE { // from class: com.google.common.cache.LocalCache.EntryFactory.8
            ...
            @Override // com.google.common.cache.LocalCache.EntryFactory
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
                return new WeakAccessWriteEntry(segment.keyReferenceQueue, k3, i3, referenceEntry);
            }
        };
        ...
        <K, V> ReferenceEntry<K, V> copyEntry(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, ReferenceEntry<K, V> referenceEntry2, K k3) {
            return newEntry(segment, k3, referenceEntry.getHash(), referenceEntry2);
        }
        ...
        abstract <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry);
    }
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        @Override // com.google.common.cache.LocalCache.ValueReference
        public ValueReference<K, V> copyFor(ReferenceQueue<V> referenceQueue, @CheckForNull V v3, ReferenceEntry<K, V> referenceEntry) {
            return this;
        }
        ...
        public ListenableFuture<V> loadFuture(K k3, CacheLoader<? super K, V> cacheLoader) {
            try {
                this.stopwatch.start();
                V v3 = this.oldValue.get();
                if (v3 == null) {
        ...
        @Override // com.google.common.cache.LocalCache.ValueReference
        public void notifyNewValue(@CheckForNull V v3) {
            if (v3 != null) {
                set(v3);
            } else {
        ...
        public boolean set(@CheckForNull V v3) {
            return this.futureValue.set(v3);
        }
    ...
    static class LocalLoadingCache<K, V> extends LocalManualCache<K, V> implements LoadingCache<K, V> {
        ...
        @Override // com.google.common.cache.LoadingCache
        public V get(K k3) {
            return this.localCache.getOrLoad(k3);
        }
    ...
    static class LocalManualCache<K, V> implements Cache<K, V>, Serializable {
        ...
        @Override // com.google.common.cache.Cache
        public V get(K k3, final Callable<? extends V> callable) {
            Preconditions.checkNotNull(callable);
            return this.localCache.get(k3, new CacheLoader<Object, V>(this) { // from class: com.google.common.cache.LocalCache.LocalManualCache.1
    ...
    static class ManualSerializationProxy<K, V> extends ForwardingCache<K, V> implements Serializable {
        ...
        private ManualSerializationProxy(Strength strength, Strength strength2, Equivalence<Object> equivalence, Equivalence<Object> equivalence2, long j3, long j4, long j5, Weigher<K, V> weigher, int i3, RemovalListener<? super K, ? super V> removalListener, Ticker ticker, CacheLoader<? super K, V> cacheLoader) {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        Segment(LocalCache<K, V> localCache, int i3, long j3, AbstractCache.StatsCounter statsCounter) {
            this.map = localCache;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        /* JADX WARN: Multi-variable type inference failed */
        public /* synthetic */ void lambda$loadAsync$0(Object obj, int i3, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
            try {
                getAndRecordStats(obj, i3, loadingValueReference, listenableFuture);
            } catch (Throwable th) {
                        ...
                        for (ReferenceEntry<K, V> referenceEntry = atomicReferenceArray.get(i3); referenceEntry != null; referenceEntry = referenceEntry.getNext()) {
                            if (referenceEntry.getValueReference().isActive()) {
                                ...
                                if (key != null && v3 != null) {
                                    ...
                                    enqueueNotification(key, referenceEntry.getHash(), v3, referenceEntry.getValueReference().getWeight(), removalCause);
                                }
        ...
        boolean containsKey(Object obj, int i3) {
            try {
                ...
                ReferenceEntry<K, V> liveEntry = getLiveEntry(obj, i3, this.map.ticker.read());
                if (liveEntry == null) {
                    return false;
                }
        ...
        ReferenceEntry<K, V> copyEntry(ReferenceEntry<K, V> referenceEntry, ReferenceEntry<K, V> referenceEntry2) {
            ...
            copyEntry.setValueReference(valueReference.copyFor(this.valueReferenceQueue, v3, copyEntry));
            return copyEntry;
        }
        ...
        void enqueueNotification(@CheckForNull K k3, int i3, @CheckForNull V v3, int i4, RemovalCause removalCause) {
            this.totalWeight -= i4;
            if (removalCause.wasEvicted()) {
                this.statsCounter.recordEviction();
            }
            if (this.map.removalNotificationQueue != LocalCache.DISCARDING_QUEUE) {
                this.map.removalNotificationQueue.offer(RemovalNotification.create(k3, v3, removalCause));
            }
        }
        ...
        void expireEntries(long j3) {
            ...
            do {
                ...
                if (peek == null || !this.map.isExpired(peek, j3)) {
                    do {
                        peek2 = this.accessQueue.peek();
                        if (peek2 == null || !this.map.isExpired(peek2, j3)) {
                            return;
                        }
        ...
        V get(Object obj, int i3) {
            try {
                if (this.count != 0) {
                    long read = this.map.ticker.read();
                    ReferenceEntry<K, V> liveEntry = getLiveEntry(obj, i3, read);
                    if (liveEntry == null) {
                        return null;
                    }
                    ...
                    if (v3 != null) {
                        ...
                        return scheduleRefresh(liveEntry, liveEntry.getKey(), i3, v3, read, this.map.defaultLoader);
                    }
        ...
        V get(K k3, int i3, CacheLoader<? super K, V> cacheLoader) {
                ...
                try {
                    if (this.count != 0 && (entry = getEntry(k3, i3)) != null) {
                        ...
                        if (liveValue != null) {
                            ...
                            return scheduleRefresh(entry, k3, i3, liveValue, read, cacheLoader);
                        }
        ...
        V getAndRecordStats(K k3, int i3, LoadingValueReference<K, V> loadingValueReference, ListenableFuture<V> listenableFuture) {
            V v3;
            try {
            ...
            try {
                if (v3 != null) {
                    ...
                    storeLoadedValue(k3, i3, loadingValueReference, v3);
                    return v3;
                }
                ...
                if (v3 == null) {
                    ...
                    removeLoadingValue(k3, i3, loadingValueReference);
                }
                throw th;
            }
        }
        ...
        ReferenceEntry<K, V> getLiveEntry(Object obj, int i3, long j3) {
            ...
            if (!this.map.isExpired(entry, j3)) {
                return entry;
            }
            tryExpireEntries(j3);
            return null;
        ...
        V getLiveValue(ReferenceEntry<K, V> referenceEntry, long j3) {
            ...
            if (!this.map.isExpired(referenceEntry, j3)) {
                return v3;
            }
            tryExpireEntries(j3);
            return null;
        ...
        @CheckForNull
        LoadingValueReference<K, V> insertLoadingValueReference(K k3, int i3, boolean z3) {
            lock();
            try {
                long read = this.map.ticker.read();
                ...
                for (ReferenceEntry referenceEntry2 = referenceEntry; referenceEntry2 != null; referenceEntry2 = referenceEntry2.getNext()) {
                    ...
                    if (referenceEntry2.getHash() == i3 && key != null && this.map.keyEquivalence.equivalent(k3, key)) {
                        ValueReference<K, V> valueReference = referenceEntry2.getValueReference();
                        if (!valueReference.isLoading() && (!z3 || read - referenceEntry2.getWriteTime() >= this.map.refreshNanos)) {
                            this.modCount++;
                ...
                ReferenceEntry<K, V> newEntry = newEntry(k3, i3, referenceEntry);
        ...
        ListenableFuture<V> loadAsync(final K k3, final int i3, final LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> cacheLoader) {
            final ListenableFuture<V> loadFuture = loadingValueReference.loadFuture(k3, cacheLoader);
            loadFuture.addListener(new Runnable() { // from class: com.google.common.cache.d
                @Override // java.lang.Runnable
                public final void run() {
                    LocalCache.Segment.this.lambda$loadAsync$0(k3, i3, loadingValueReference, loadFuture);
                }
            }, MoreExecutors.directExecutor());
            return loadFuture;
        }

        V loadSync(K k3, int i3, LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> cacheLoader) {
            return getAndRecordStats(k3, i3, loadingValueReference, loadingValueReference.loadFuture(k3, cacheLoader));
        }

        V lockedGetOrLoad(K k3, int i3, CacheLoader<? super K, V> cacheLoader) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (referenceEntry2.getHash() == i3 && key != null && this.map.keyEquivalence.equivalent(k3, key)) {
                        ...
                        if (valueReference2.isLoading()) {
                            ...
                            enqueueNotification(key, i3, v3, weight, removalCause);
                ...
                if (z3) {
                    ...
                    if (referenceEntry2 == null) {
                        referenceEntry2 = newEntry(k3, i3, referenceEntry);
                        referenceEntry2.setValueReference(loadingValueReference);
                ...
                if (!z3) {
                    return waitForLoadingValue(referenceEntry2, k3, valueReference);
                }
                try {
                    synchronized (referenceEntry2) {
                        loadSync = loadSync(k3, i3, loadingValueReference, cacheLoader);
                    }
                    return loadSync;
                } finally {
        ...
        ReferenceEntry<K, V> newEntry(K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
            return this.map.entryFactory.newEntry(this, Preconditions.checkNotNull(k3), i3, referenceEntry);
        }
            ...
            try {
                ...
                while (true) {
                    if (referenceEntry2 == null) {
                        this.modCount++;
                        referenceEntry2 = newEntry(k3, i3, referenceEntry);
                        setValue(referenceEntry2, k3, v3, read);
                        atomicReferenceArray.set(length, referenceEntry2);
                        this.count++;
                        break;
                    }
                    ...
                    if (referenceEntry2.getHash() == i3 && key != null && this.map.keyEquivalence.equivalent(k3, key)) {
                        ...
                        if (v4 != null) {
                            if (z3) {
                                ...
                                this.modCount++;
                                enqueueNotification(k3, i3, v4, valueReference.getWeight(), RemovalCause.REPLACED);
                                setValue(referenceEntry2, k3, v3, read);
                        ...
                        if (valueReference.isActive()) {
                            enqueueNotification(k3, i3, v4, valueReference.getWeight(), RemovalCause.COLLECTED);
                            setValue(referenceEntry2, k3, v3, read);
                            i4 = this.count;
                        } else {
                            setValue(referenceEntry2, k3, v3, read);
            ...
            try {
                ...
                for (ReferenceEntry<K, V> referenceEntry3 = referenceEntry2; referenceEntry3 != null; referenceEntry3 = referenceEntry3.getNext()) {
                    if (referenceEntry3 == referenceEntry) {
                        this.modCount++;
                        ReferenceEntry<K, V> removeValueFromChain = removeValueFromChain(referenceEntry2, referenceEntry3, referenceEntry3.getKey(), i3, referenceEntry3.getValueReference().get(), referenceEntry3.getValueReference(), RemovalCause.COLLECTED);
                        int i4 = this.count - 1;
        ...
        boolean reclaimValue(K k3, int i3, ValueReference<K, V> valueReference) {
            lock();
            try {
                AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
                int length = (atomicReferenceArray.length() - 1) & i3;
                ...
                for (ReferenceEntry<K, V> referenceEntry2 = referenceEntry; referenceEntry2 != null; referenceEntry2 = referenceEntry2.getNext()) {
                    ...
                    if (referenceEntry2.getHash() == i3 && key != null && this.map.keyEquivalence.equivalent(k3, key)) {
                        ...
                        this.modCount++;
                        ReferenceEntry<K, V> removeValueFromChain = removeValueFromChain(referenceEntry, referenceEntry2, key, i3, valueReference.get(), valueReference, RemovalCause.COLLECTED);
                        int i4 = this.count - 1;
                        atomicReferenceArray.set(length, removeValueFromChain);
                        this.count = i4;
                        return true;
        ...
        void recordLockedRead(ReferenceEntry<K, V> referenceEntry, long j3) {
        ...
        void recordRead(ReferenceEntry<K, V> referenceEntry, long j3) {
            if (this.map.recordsAccess()) {
                referenceEntry.setAccessTime(j3);
            }
        ...
        void recordWrite(ReferenceEntry<K, V> referenceEntry, int i3, long j3) {
            drainRecencyQueue();
            this.totalWeight += i3;
            if (this.map.recordsAccess()) {
                referenceEntry.setAccessTime(j3);
        ...
        @CheckForNull
        V refresh(K k3, int i3, CacheLoader<? super K, V> cacheLoader, boolean z3) {
            LoadingValueReference<K, V> insertLoadingValueReference = insertLoadingValueReference(k3, i3, z3);
            if (insertLoadingValueReference == null) {
                return null;
            }
            ListenableFuture<V> loadAsync = loadAsync(k3, i3, insertLoadingValueReference, cacheLoader);
            if (loadAsync.isDone()) {
                try {
        ...
        */
        ...
        boolean removeEntry(ReferenceEntry<K, V> referenceEntry, int i3, RemovalCause removalCause) {
            ...
            for (ReferenceEntry<K, V> referenceEntry3 = referenceEntry2; referenceEntry3 != null; referenceEntry3 = referenceEntry3.getNext()) {
                if (referenceEntry3 == referenceEntry) {
                    this.modCount++;
                    ReferenceEntry<K, V> removeValueFromChain = removeValueFromChain(referenceEntry2, referenceEntry3, referenceEntry3.getKey(), i3, referenceEntry3.getValueReference().get(), referenceEntry3.getValueReference(), removalCause);
                    int i4 = this.count - 1;
                    atomicReferenceArray.set(length, removeValueFromChain);
                    this.count = i4;
                    return true;
        ...
        boolean removeLoadingValue(K k3, int i3, LoadingValueReference<K, V> loadingValueReference) {
            lock();
            try {
                AtomicReferenceArray<ReferenceEntry<K, V>> atomicReferenceArray = this.table;
                int length = (atomicReferenceArray.length() - 1) & i3;
        ...
        @CheckForNull
        ReferenceEntry<K, V> removeValueFromChain(ReferenceEntry<K, V> referenceEntry, ReferenceEntry<K, V> referenceEntry2, @CheckForNull K k3, int i3, V v3, ValueReference<K, V> valueReference, RemovalCause removalCause) {
            enqueueNotification(k3, i3, v3, valueReference.getWeight(), removalCause);
            this.writeQueue.remove(referenceEntry2);
            this.accessQueue.remove(referenceEntry2);
            if (!valueReference.isLoading()) {
        ...
        */
        ...
        V scheduleRefresh(ReferenceEntry<K, V> referenceEntry, K k3, int i3, V v3, long j3, CacheLoader<? super K, V> cacheLoader) {
            V refresh;
            return (!this.map.refreshes() || j3 - referenceEntry.getWriteTime() <= this.map.refreshNanos || referenceEntry.getValueReference().isLoading() || (refresh = refresh(k3, i3, cacheLoader, true)) == null) ? v3 : refresh;
        }

        void setValue(ReferenceEntry<K, V> referenceEntry, K k3, V v3, long j3) {
            ValueReference<K, V> valueReference = referenceEntry.getValueReference();
            int weigh = this.map.weigher.weigh(k3, v3);
            Preconditions.checkState(weigh >= 0, "Weights must be non-negative");
            referenceEntry.setValueReference(this.map.valueStrength.referenceValue(this, referenceEntry, v3, weigh));
            recordWrite(referenceEntry, weigh, j3);
            valueReference.notifyNewValue(v3);
        }

        boolean storeLoadedValue(K k3, int i3, LoadingValueReference<K, V> loadingValueReference, V v3) {
            lock();
            try {
                long read = this.map.ticker.read();
                preWriteCleanup(read);
                ...
                while (true) {
                    ...
                    if (referenceEntry2.getHash() == i3 && key != null && this.map.keyEquivalence.equivalent(k3, key)) {
                        ValueReference<K, V> valueReference = referenceEntry2.getValueReference();
                        V v4 = valueReference.get();
                        if (loadingValueReference != valueReference && (v4 != null || valueReference == LocalCache.UNSET)) {
                            enqueueNotification(k3, i3, v3, 0, RemovalCause.REPLACED);
                            return false;
                        }
                        this.modCount++;
                        if (loadingValueReference.isActive()) {
                            enqueueNotification(k3, i3, v4, loadingValueReference.getWeight(), v4 == null ? RemovalCause.COLLECTED : RemovalCause.REPLACED);
                            i5--;
                        }
                        setValue(referenceEntry2, k3, v3, read);
                        this.count = i5;
        ...
        V waitForLoadingValue(ReferenceEntry<K, V> referenceEntry, K k3, ValueReference<K, V> valueReference) {
            if (!valueReference.isLoading()) {
                throw new AssertionError();
            }
            Preconditions.checkState(!Thread.holdsLock(referenceEntry), "Recursive load of: %s", k3);
            try {
    ...
    static class SoftValueReference<K, V> extends SoftReference<V> implements ValueReference<K, V> {
        ...
        @Override // com.google.common.cache.LocalCache.ValueReference
        public ValueReference<K, V> copyFor(ReferenceQueue<V> referenceQueue, V v3, ReferenceEntry<K, V> referenceEntry) {
    ...
    enum Strength {
        STRONG { // from class: com.google.common.cache.LocalCache.Strength.1
            ...
            @Override // com.google.common.cache.LocalCache.Strength
            <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v3, int i3) {
                return i3 == 1 ? new StrongValueReference(v3) : new WeightedStrongValueReference(v3, i3);
            }
        },
        SOFT { // from class: com.google.common.cache.LocalCache.Strength.2
            ...
            @Override // com.google.common.cache.LocalCache.Strength
            <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v3, int i3) {
                return i3 == 1 ? new SoftValueReference(segment.valueReferenceQueue, v3, referenceEntry) : new WeightedSoftValueReference(segment.valueReferenceQueue, v3, referenceEntry, i3);
            }
        },
        WEAK { // from class: com.google.common.cache.LocalCache.Strength.3
            ...
            @Override // com.google.common.cache.LocalCache.Strength
            <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v3, int i3) {
                return i3 == 1 ? new WeakValueReference(segment.valueReferenceQueue, v3, referenceEntry) : new WeightedWeakValueReference(segment.valueReferenceQueue, v3, referenceEntry, i3);
            }
        };

        abstract Equivalence<Object> defaultEquivalence();

        abstract <K, V> ValueReference<K, V> referenceValue(Segment<K, V> segment, ReferenceEntry<K, V> referenceEntry, V v3, int i3);
    }
    ...
    static final class StrongAccessEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongAccessEntry(K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
            super(k3, i3, referenceEntry);
    ...
    static final class StrongAccessWriteEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongAccessWriteEntry(K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
            super(k3, i3, referenceEntry);
            this.accessTime = Long.MAX_VALUE;
            this.nextAccess = LocalCache.nullEntry();
            this.previousAccess = LocalCache.nullEntry();
    ...
    static class StrongEntry<K, V> extends AbstractReferenceEntry<K, V> {
        ...
        StrongEntry(K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
            this.key = k3;
            this.hash = i3;
    ...
    static final class StrongWriteEntry<K, V> extends StrongEntry<K, V> {
        ...
        StrongWriteEntry(K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
            super(k3, i3, referenceEntry);
            this.writeTime = Long.MAX_VALUE;
            this.nextWrite = LocalCache.nullEntry();
            this.previousWrite = LocalCache.nullEntry();
    ...
    interface ValueReference<K, V> {
        ValueReference<K, V> copyFor(ReferenceQueue<V> referenceQueue, @CheckForNull V v3, ReferenceEntry<K, V> referenceEntry);
        ...
        void notifyNewValue(@CheckForNull V v3);
    ...
    static final class WeakAccessEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakAccessEntry(ReferenceQueue<K> referenceQueue, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k3, i3, referenceEntry);
            this.accessTime = Long.MAX_VALUE;
            this.nextAccess = LocalCache.nullEntry();
            this.previousAccess = LocalCache.nullEntry();
        }
    ...
    static final class WeakAccessWriteEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakAccessWriteEntry(ReferenceQueue<K> referenceQueue, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k3, i3, referenceEntry);
            this.accessTime = Long.MAX_VALUE;
            this.nextAccess = LocalCache.nullEntry();
            this.previousAccess = LocalCache.nullEntry();
    ...
    static class WeakEntry<K, V> extends WeakReference<K> implements ReferenceEntry<K, V> {
        ...
        WeakEntry(ReferenceQueue<K> referenceQueue, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
    ...
    static final class WeakWriteEntry<K, V> extends WeakEntry<K, V> {
        ...
        WeakWriteEntry(ReferenceQueue<K> referenceQueue, K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
            super(referenceQueue, k3, i3, referenceEntry);
            this.writeTime = Long.MAX_VALUE;
            this.nextWrite = LocalCache.nullEntry();
            this.previousWrite = LocalCache.nullEntry();
    ...
    static final class WeightedSoftValueReference<K, V> extends SoftValueReference<K, V> {
        ...
        WeightedSoftValueReference(ReferenceQueue<V> referenceQueue, V v3, ReferenceEntry<K, V> referenceEntry, int i3) {
        ...
        public ValueReference<K, V> copyFor(ReferenceQueue<V> referenceQueue, V v3, ReferenceEntry<K, V> referenceEntry) {
            return new WeightedSoftValueReference(referenceQueue, v3, referenceEntry, this.weight);
        }
    ...
    static final class WeightedStrongValueReference<K, V> extends StrongValueReference<K, V> {
        ...
        WeightedStrongValueReference(V v3, int i3) {
            super(v3);
            this.weight = i3;
        }
    ...
    static final class WeightedWeakValueReference<K, V> extends WeakValueReference<K, V> {
        ...
        WeightedWeakValueReference(ReferenceQueue<V> referenceQueue, V v3, ReferenceEntry<K, V> referenceEntry, int i3) {
            super(referenceQueue, v3, referenceEntry);
            this.weight = i3;
        }
        ...
        public ValueReference<K, V> copyFor(ReferenceQueue<V> referenceQueue, V v3, ReferenceEntry<K, V> referenceEntry) {
            return new WeightedWeakValueReference(referenceQueue, v3, referenceEntry, this.weight);
        }
    ...
    final class WriteThroughEntry implements Map.Entry<K, V> {
        ...
        public V setValue(V v3) {
            V v4 = (V) LocalCache.this.put(this.key, v3);
            this.value = v3;
            return v4;
        }
    ...
    LocalCache(CacheBuilder<? super K, ? super V> cacheBuilder, @CheckForNull CacheLoader<? super K, V> cacheLoader) {
        ...
        if (evictsBySize()) {
            ...
            while (true) {
                ...
                segmentArr[i3] = createSegment(i4, j5, cacheBuilder.getStatsCounterSupplier().get());
                i3++;
            }
        } else {
            while (true) {
                ...
                segmentArr2[i3] = createSegment(i4, -1L, cacheBuilder.getStatsCounterSupplier().get());
                i3++;
            }
        }
    }
    ...
    Segment<K, V> createSegment(int i3, long j3, AbstractCache.StatsCounter statsCounter) {
    ...
    V get(K k3, CacheLoader<? super K, V> cacheLoader) {
        int hash = hash(Preconditions.checkNotNull(k3));
        return segmentFor(hash).get(k3, hash, cacheLoader);
    }
    ...
    ImmutableMap<K, V> getAll(Iterable<? extends K> iterable) {
        ...
        try {
            ...
            this.globalStatsCounter.recordMisses(i4);
        }
    }
    ...
    public V getIfPresent(Object obj) {
        ...
        V v3 = segmentFor(hash).get(obj, hash);
    ...
    V getLiveValue(ReferenceEntry<K, V> referenceEntry, long j3) {
        V v3;
        if (referenceEntry.getKey() == null || (v3 = referenceEntry.getValueReference().get()) == null || isExpired(referenceEntry, j3)) {
            return null;
        }
        return v3;
    }
    ...
    boolean isLive(ReferenceEntry<K, V> referenceEntry, long j3) {
        return segmentFor(referenceEntry.getHash()).getLiveValue(referenceEntry, j3) != null;
    }
    ...
    */
    ...
    ReferenceEntry<K, V> newEntry(K k3, int i3, @CheckForNull ReferenceEntry<K, V> referenceEntry) {
        Segment<K, V> segmentFor = segmentFor(i3);
        segmentFor.lock();
        try {
            return segmentFor.newEntry(k3, i3, referenceEntry);
        } finally {
            segmentFor.unlock();
        }
    }

    final Segment<K, V>[] newSegmentArray(int i3) {
        return new Segment[i3];
    }

    /* JADX WARN: Multi-variable type inference failed */
    ValueReference<K, V> newValueReference(ReferenceEntry<K, V> referenceEntry, V v3, int i3) {
        return this.valueStrength.referenceValue(segmentFor(referenceEntry.getHash()), referenceEntry, Preconditions.checkNotNull(v3), i3);
    }
    ...
    void refresh(K k3) {
        int hash = hash(Preconditions.checkNotNull(k3));
        segmentFor(hash).refresh(k3, hash, this.defaultLoader, false);
    }
