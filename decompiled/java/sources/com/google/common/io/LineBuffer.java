...
abstract class LineBuffer {
    ...
    private boolean finishLine(boolean z3) {
        handleLine(this.line.toString(), this.sawReturn ? z3 ? IOUtils.LINE_SEPARATOR_WINDOWS : "\r" : z3 ? IOUtils.LINE_SEPARATOR_UNIX : "");
    ...
    */
    protected void add(char[] r7, int r8, int r9) {
        /*
            r6 = this;
