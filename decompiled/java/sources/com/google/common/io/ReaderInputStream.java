...
final class ReaderInputStream extends InputStream {
    ...
    ReaderInputStream(Reader reader, Charset charset, int i3) {
    ...
    ReaderInputStream(Reader reader, CharsetEncoder charsetEncoder, int i3) {
    ...
    private int drain(byte[] bArr, int i3, int i4) {
        int min = Math.min(i4, this.byteBuffer.remaining());
    ...
    private void startDraining(boolean z3) {
        Java8Compatibility.flip(this.byteBuffer);
        if (z3 && this.byteBuffer.remaining() == 0) {
