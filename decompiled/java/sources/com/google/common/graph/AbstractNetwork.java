...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    class AnonymousClass1 extends AbstractGraph<N> {
        ...
        class C00611 extends AbstractSet<EndpointPair<N>> {
            C00611() {
            }
            ...
            public Iterator<EndpointPair<N>> iterator() {
                return Iterators.transform(AbstractNetwork.this.edges().iterator(), new Function() { // from class: com.google.common.graph.e
                    ...
                    public final Object apply(Object obj) {
                        ...
                        lambda$iterator$0 = AbstractNetwork.AnonymousClass1.C00611.this.lambda$iterator$0(obj);
        ...
        public Set<N> adjacentNodes(N n3) {
            return AbstractNetwork.this.adjacentNodes(n3);
        }
        ...
        public Set<EndpointPair<N>> edges() {
            return AbstractNetwork.this.allowsParallelEdges() ? super.edges() : new C00611();
        }
        ...
        public Set<N> predecessors(N n3) {
            return AbstractNetwork.this.predecessors((AbstractNetwork) n3);
        }
        ...
        public Set<N> successors(N n3) {
            return AbstractNetwork.this.successors((AbstractNetwork) n3);
        }
    }

    private Predicate<E> connectedPredicate(final N n3, final N n4) {
        return new Predicate<E>() { // from class: com.google.common.graph.AbstractNetwork.2
            /* JADX WARN: Multi-variable type inference failed */
            @Override // com.google.common.base.Predicate
            public boolean apply(E e3) {
                return AbstractNetwork.this.incidentNodes(e3).adjacentNode(n3).equals(n4);
            }
        };
    }
    ...
    public Set<E> adjacentEdges(E e3) {
        ...
        return Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.of((Object) e3));
    }
    ...
    public int degree(N n3) {
        ...
        if (isDirected()) {
            size = inEdges(n3).size();
            edgesConnecting = outEdges(n3);
        } else {
            size = incidentEdges(n3).size();
            edgesConnecting = edgesConnecting(n3, n3);
        }
    ...
    public Set<E> edgesConnecting(N n3, N n4) {
        Set<E> outEdges = outEdges(n3);
        Set<E> inEdges = inEdges(n4);
        return Collections.unmodifiableSet(outEdges.size() <= inEdges.size() ? Sets.filter(outEdges, connectedPredicate(n3, n4)) : Sets.filter(inEdges, connectedPredicate(n4, n3)));
    }
    ...
    public boolean hasEdgeConnecting(N n3, N n4) {
        ...
        return nodes().contains(n3) && successors((AbstractNetwork<N, E>) n3).contains(n4);
    }
