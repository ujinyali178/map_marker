...
public final class ImmutableValueGraph<N, V> extends StandardValueGraph<N, V> {
    ...
    public static class Builder<N, V> {
        ...
        public Builder<N, V> addNode(N n3) {
            this.mutableValueGraph.addNode(n3);
            return this;
        }
        ...
        public Builder<N, V> putEdgeValue(EndpointPair<N> endpointPair, V v3) {
            this.mutableValueGraph.putEdgeValue(endpointPair, v3);
            return this;
        }

        public Builder<N, V> putEdgeValue(N n3, N n4, V v3) {
            this.mutableValueGraph.putEdgeValue(n3, n4, v3);
            return this;
        }
    }
    ...
    private static <N, V> GraphConnections<N, V> connectionsOf(final ValueGraph<N, V> valueGraph, final N n3) {
        Function function = new Function() { // from class: com.google.common.graph.p
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                Object lambda$connectionsOf$0;
                lambda$connectionsOf$0 = ImmutableValueGraph.lambda$connectionsOf$0(ValueGraph.this, n3, obj);
                return lambda$connectionsOf$0;
            }
        };
        return valueGraph.isDirected() ? DirectedGraphConnections.ofImmutable(n3, valueGraph.incidentEdges(n3), function) : UndirectedGraphConnections.ofImmutable(Maps.asMap(valueGraph.adjacentNodes(n3), function));
    }
    ...
    private static <N, V> ImmutableMap<N, GraphConnections<N, V>> getNodeConnections(ValueGraph<N, V> valueGraph) {
        ...
        for (N n3 : valueGraph.nodes()) {
            builder.put(n3, connectionsOf(valueGraph, n3));
        }
