...
public class ClusterManager<T extends ClusterItem> implements GoogleMap.OnCameraIdleListener, GoogleMap.OnMarkerClickListener, GoogleMap.OnInfoWindowClickListener {
    ...
    public interface OnClusterItemInfoWindowLongClickListener<T extends ClusterItem> {
        void onClusterItemInfoWindowLongClick(T t3);
    }
    ...
    public boolean removeItem(T t3) {
        ...
        algorithm.lock();
        try {
            return algorithm.removeItem(t3);
        } finally {
            algorithm.unlock();
        }
    }
    ...
    public void setAnimation(boolean z3) {
        this.mRenderer.setAnimation(z3);
    }
    ...
    public boolean updateItem(T t3) {
        ...
        algorithm.lock();
        try {
            return algorithm.updateItem(t3);
        } finally {
            algorithm.unlock();
        }
    }
