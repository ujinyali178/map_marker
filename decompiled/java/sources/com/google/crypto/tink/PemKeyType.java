...
public final class PemKeyType {
    ...
    @Nullable
    public java.security.Key readKey(BufferedReader bufferedReader) {
        String readLine;
        String substring;
        int indexOf;
        byte[] decode;
