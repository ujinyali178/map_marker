...
public class UnmodifiableLazyStringList extends AbstractList<String> implements LazyStringList, RandomAccess {
    ...
    public ListIterator<String> listIterator(int i3) {
        return new ListIterator<String>(i3) { // from class: com.google.crypto.tink.shaded.protobuf.UnmodifiableLazyStringList.1
            ListIterator<String> iter;
            final /* synthetic */ int val$index;

            {
                this.val$index = i3;
                this.iter = UnmodifiableLazyStringList.this.list.listIterator(i3);
            }
