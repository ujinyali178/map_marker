...
public final class EnumValue extends GeneratedMessageLite<EnumValue, Builder> implements EnumValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<EnumValue, Builder> implements EnumValueOrBuilder {
        ...
        public Builder addOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((EnumValue) this.instance).addOptions(i3, builder.build());
            return this;
        }

        public Builder addOptions(int i3, Option option) {
            copyOnWrite();
            ((EnumValue) this.instance).addOptions(i3, option);
            return this;
        }
        ...
        public Option getOptions(int i3) {
            return ((EnumValue) this.instance).getOptions(i3);
        }
        ...
        public Builder removeOptions(int i3) {
            copyOnWrite();
            ((EnumValue) this.instance).removeOptions(i3);
            return this;
        }
        ...
        public Builder setNumber(int i3) {
            copyOnWrite();
            ((EnumValue) this.instance).setNumber(i3);
            return this;
        }

        public Builder setOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((EnumValue) this.instance).setOptions(i3, builder.build());
            return this;
        }

        public Builder setOptions(int i3, Option option) {
            copyOnWrite();
            ((EnumValue) this.instance).setOptions(i3, option);
            return this;
        }
    }
