...
public class MapEntryLite<K, V> {
    ...
    private MapEntryLite(Metadata<K, V> metadata, K k3, V v3) {
        this.metadata = metadata;
        this.key = k3;
        this.value = v3;
    }

    private MapEntryLite(WireFormat.FieldType fieldType, K k3, WireFormat.FieldType fieldType2, V v3) {
        this.metadata = new Metadata<>(fieldType, k3, fieldType2, v3);
        this.key = k3;
        this.value = v3;
    }

    static <K, V> int computeSerializedSize(Metadata<K, V> metadata, K k3, V v3) {
        return FieldSet.computeElementSize(metadata.keyType, 1, k3) + FieldSet.computeElementSize(metadata.valueType, 2, v3);
    }

    public static <K, V> MapEntryLite<K, V> newDefaultInstance(WireFormat.FieldType fieldType, K k3, WireFormat.FieldType fieldType2, V v3) {
        return new MapEntryLite<>(fieldType, k3, fieldType2, v3);
    }
    ...
    static <T> T parseField(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, WireFormat.FieldType fieldType, T t3) {
        int i3 = AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()];
        if (i3 == 1) {
    ...
    static <K, V> void writeTo(CodedOutputStream codedOutputStream, Metadata<K, V> metadata, K k3, V v3) {
        FieldSet.writeElement(codedOutputStream, metadata.keyType, 1, k3);
        FieldSet.writeElement(codedOutputStream, metadata.valueType, 2, v3);
    }

    public int computeMessageSize(int i3, K k3, V v3) {
        return CodedOutputStream.computeTagSize(i3) + CodedOutputStream.computeLengthDelimitedFieldSize(computeSerializedSize(this.metadata, k3, v3));
    }
    ...
    public void serializeTo(CodedOutputStream codedOutputStream, int i3, K k3, V v3) {
        codedOutputStream.writeTag(i3, 2);
        codedOutputStream.writeUInt32NoTag(computeSerializedSize(this.metadata, k3, v3));
        writeTo(codedOutputStream, this.metadata, k3, v3);
    }
}
