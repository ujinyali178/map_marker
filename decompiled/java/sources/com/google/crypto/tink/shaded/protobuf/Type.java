...
public final class Type extends GeneratedMessageLite<Type, Builder> implements TypeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Type, Builder> implements TypeOrBuilder {
        ...
        public Builder addFields(int i3, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addFields(i3, builder.build());
            return this;
        }

        public Builder addFields(int i3, Field field) {
            copyOnWrite();
            ((Type) this.instance).addFields(i3, field);
            return this;
        }
        ...
        public Builder addOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i3, builder.build());
            return this;
        }

        public Builder addOptions(int i3, Option option) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i3, option);
            return this;
        }
        ...
        public Field getFields(int i3) {
            return ((Type) this.instance).getFields(i3);
        }
        ...
        public String getOneofs(int i3) {
            return ((Type) this.instance).getOneofs(i3);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.TypeOrBuilder
        public ByteString getOneofsBytes(int i3) {
            return ((Type) this.instance).getOneofsBytes(i3);
        }
        ...
        public Option getOptions(int i3) {
            return ((Type) this.instance).getOptions(i3);
        }
        ...
        public Builder removeFields(int i3) {
            copyOnWrite();
            ((Type) this.instance).removeFields(i3);
            return this;
        }

        public Builder removeOptions(int i3) {
            copyOnWrite();
            ((Type) this.instance).removeOptions(i3);
            return this;
        }

        public Builder setFields(int i3, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setFields(i3, builder.build());
            return this;
        }

        public Builder setFields(int i3, Field field) {
            copyOnWrite();
            ((Type) this.instance).setFields(i3, field);
            return this;
        }
        ...
        public Builder setOneofs(int i3, String str) {
            copyOnWrite();
            ((Type) this.instance).setOneofs(i3, str);
            return this;
        }

        public Builder setOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i3, builder.build());
            return this;
        }

        public Builder setOptions(int i3, Option option) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i3, option);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i3) {
            copyOnWrite();
            ((Type) this.instance).setSyntaxValue(i3);
            return this;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addFields(int i3, Field field) {
        field.getClass();
        ensureFieldsIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void removeFields(int i3) {
        ensureFieldsIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setFields(int i3, Field field) {
        field.getClass();
        ensureFieldsIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setOneofs(int i3, String str) {
        str.getClass();
        ensureOneofsIsMutable();
    ...
    public FieldOrBuilder getFieldsOrBuilder(int i3) {
        return this.fields_.get(i3);
    }
    ...
    @Override // com.google.crypto.tink.shaded.protobuf.TypeOrBuilder
    public ByteString getOneofsBytes(int i3) {
        return ByteString.copyFromUtf8(this.oneofs_.get(i3));
    }
