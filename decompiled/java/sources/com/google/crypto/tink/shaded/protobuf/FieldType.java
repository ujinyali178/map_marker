...
public final class FieldType {
    ...
    private FieldType(String str, int i3, int i4, Collection collection, JavaType javaType) {
        int i5;
        this.id = i4;
        this.collection = collection;
        this.javaType = javaType;
        int i6 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        this.elementType = (i6 == 1 || i6 == 2) ? javaType.getBoxedType() : null;
        this.primitiveScalar = (collection != Collection.SCALAR || (i5 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i5 == 2 || i5 == 3) ? false : true;
    }
        ...
        while (true) {
            ...
            if (!(genericSuperList instanceof ParameterizedType)) {
                ...
                for (int i4 = 0; i4 < actualTypeArguments.length; i4++) {
                    java.lang.reflect.Type type = actualTypeArguments[i4];
                    if (type instanceof TypeVariable) {
                        ...
                        while (true) {
                            ...
                            if (type == typeParameters[i5]) {
                                actualTypeArguments[i4] = typeArr[i5];
                                z3 = true;
                                break;
                            }
                            i5++;
