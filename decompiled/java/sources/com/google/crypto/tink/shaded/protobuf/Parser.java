...
public interface Parser<MessageType> {
    ...
    MessageType parseFrom(byte[] bArr, int i3, int i4);

    MessageType parseFrom(byte[] bArr, int i3, int i4, ExtensionRegistryLite extensionRegistryLite);
    ...
    MessageType parsePartialFrom(byte[] bArr, int i3, int i4);

    MessageType parsePartialFrom(byte[] bArr, int i3, int i4, ExtensionRegistryLite extensionRegistryLite);
