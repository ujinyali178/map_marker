...
public final class Method extends GeneratedMessageLite<Method, Builder> implements MethodOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Method, Builder> implements MethodOrBuilder {
        ...
        public Builder addOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).addOptions(i3, builder.build());
            return this;
        }

        public Builder addOptions(int i3, Option option) {
            copyOnWrite();
            ((Method) this.instance).addOptions(i3, option);
            return this;
        }
        ...
        public Option getOptions(int i3) {
            return ((Method) this.instance).getOptions(i3);
        }
        ...
        public Builder removeOptions(int i3) {
            copyOnWrite();
            ((Method) this.instance).removeOptions(i3);
            return this;
        }
        ...
        public Builder setOptions(int i3, Option.Builder builder) {
            copyOnWrite();
            ((Method) this.instance).setOptions(i3, builder.build());
            return this;
        }

        public Builder setOptions(int i3, Option option) {
            copyOnWrite();
            ((Method) this.instance).setOptions(i3, option);
            return this;
        }

        public Builder setRequestStreaming(boolean z3) {
            copyOnWrite();
            ((Method) this.instance).setRequestStreaming(z3);
            return this;
        }
        ...
        public Builder setResponseStreaming(boolean z3) {
            copyOnWrite();
            ((Method) this.instance).setResponseStreaming(z3);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i3) {
            copyOnWrite();
            ((Method) this.instance).setSyntaxValue(i3);
            return this;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setRequestStreaming(boolean z3) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setResponseStreaming(boolean z3) {
