...
public final class FieldMask extends GeneratedMessageLite<FieldMask, Builder> implements FieldMaskOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<FieldMask, Builder> implements FieldMaskOrBuilder {
        ...
        public String getPaths(int i3) {
            return ((FieldMask) this.instance).getPaths(i3);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.FieldMaskOrBuilder
        public ByteString getPathsBytes(int i3) {
            return ((FieldMask) this.instance).getPathsBytes(i3);
        }
        ...
        public Builder setPaths(int i3, String str) {
            copyOnWrite();
            ((FieldMask) this.instance).setPaths(i3, str);
            return this;
        }
    }
    ...
    @Override // com.google.crypto.tink.shaded.protobuf.FieldMaskOrBuilder
    public ByteString getPathsBytes(int i3) {
        return ByteString.copyFromUtf8(this.paths_.get(i3));
    }
