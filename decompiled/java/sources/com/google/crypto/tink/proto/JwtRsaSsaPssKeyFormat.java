...
public final class JwtRsaSsaPssKeyFormat extends GeneratedMessageLite<JwtRsaSsaPssKeyFormat, Builder> implements JwtRsaSsaPssKeyFormatOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<JwtRsaSsaPssKeyFormat, Builder> implements JwtRsaSsaPssKeyFormatOrBuilder {
        ...
        public Builder setAlgorithmValue(int i3) {
            copyOnWrite();
            ((JwtRsaSsaPssKeyFormat) this.instance).setAlgorithmValue(i3);
            return this;
        }

        public Builder setModulusSizeInBits(int i3) {
            copyOnWrite();
            ((JwtRsaSsaPssKeyFormat) this.instance).setModulusSizeInBits(i3);
            return this;
        }
        ...
        public Builder setVersion(int i3) {
            copyOnWrite();
            ((JwtRsaSsaPssKeyFormat) this.instance).setVersion(i3);
            return this;
        }
    }
