...
public final class EciesHkdfKemParams extends GeneratedMessageLite<EciesHkdfKemParams, Builder> implements EciesHkdfKemParamsOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<EciesHkdfKemParams, Builder> implements EciesHkdfKemParamsOrBuilder {
        ...
        public Builder setCurveTypeValue(int i3) {
            copyOnWrite();
            ((EciesHkdfKemParams) this.instance).setCurveTypeValue(i3);
            return this;
        }
        ...
        public Builder setHkdfHashTypeValue(int i3) {
            copyOnWrite();
            ((EciesHkdfKemParams) this.instance).setHkdfHashTypeValue(i3);
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setCurveTypeValue(int i3) {
        this.curveType_ = i3;
    }
