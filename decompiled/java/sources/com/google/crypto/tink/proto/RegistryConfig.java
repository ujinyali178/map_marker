...
public final class RegistryConfig extends GeneratedMessageLite<RegistryConfig, Builder> implements RegistryConfigOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<RegistryConfig, Builder> implements RegistryConfigOrBuilder {
        ...
        public Builder addEntry(int i3, KeyTypeEntry.Builder builder) {
            copyOnWrite();
            ((RegistryConfig) this.instance).addEntry(i3, builder.build());
            return this;
        }

        public Builder addEntry(int i3, KeyTypeEntry keyTypeEntry) {
            copyOnWrite();
            ((RegistryConfig) this.instance).addEntry(i3, keyTypeEntry);
            return this;
        }
        ...
        @Override // com.google.crypto.tink.proto.RegistryConfigOrBuilder
        public KeyTypeEntry getEntry(int i3) {
            return ((RegistryConfig) this.instance).getEntry(i3);
        }
        ...
        public Builder removeEntry(int i3) {
            copyOnWrite();
            ((RegistryConfig) this.instance).removeEntry(i3);
            return this;
        }
        ...
        public Builder setEntry(int i3, KeyTypeEntry.Builder builder) {
            copyOnWrite();
            ((RegistryConfig) this.instance).setEntry(i3, builder.build());
            return this;
        }

        public Builder setEntry(int i3, KeyTypeEntry keyTypeEntry) {
            copyOnWrite();
            ((RegistryConfig) this.instance).setEntry(i3, keyTypeEntry);
            return this;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addEntry(int i3, KeyTypeEntry keyTypeEntry) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setEntry(int i3, KeyTypeEntry keyTypeEntry) {
        keyTypeEntry.getClass();
        ensureEntryIsMutable();
    ...
    public KeyTypeEntryOrBuilder getEntryOrBuilder(int i3) {
        return this.entry_.get(i3);
    }
