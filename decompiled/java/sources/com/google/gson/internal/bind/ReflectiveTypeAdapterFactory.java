            ...
            while (i3 < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    while (i4 < size) {
                        ...
                        boolean z4 = i4 != 0 ? false : excludeField;
                        int i5 = i4;
                        BoundField boundField2 = boundField;
                        int i6 = size;
                        List<String> list = fieldNames;
                        Field field2 = field;
                        boundField = boundField2 == null ? (BoundField) linkedHashMap.put(str, createBoundField(gson, field, str, TypeToken.get(resolve), z4, excludeField2)) : boundField2;
                        i4 = i5 + 1;
                        excludeField = z4;
                        fieldNames = list;
                        size = i6;
