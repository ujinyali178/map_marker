...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    private boolean excludeClassInStrategy(Class<?> cls, boolean z3) {
        Iterator<ExclusionStrategy> it = (z3 ? this.serializationStrategies : this.deserializationStrategies).iterator();
        while (it.hasNext()) {
    ...
    public Excluder disableInnerClassSerialization() {
        ...
        m11clone.serializeInnerClasses = false;
        return m11clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z3, boolean z4) {
        ...
        if (z3) {
            ...
            m11clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z4) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            m11clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder m11clone = m11clone();
        m11clone.modifiers = 0;
        for (int i3 : iArr) {
            m11clone.modifiers = i3 | m11clone.modifiers;
        }
        return m11clone;
    }
