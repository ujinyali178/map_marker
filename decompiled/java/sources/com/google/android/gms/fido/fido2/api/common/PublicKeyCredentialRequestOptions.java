...
public class PublicKeyCredentialRequestOptions extends RequestOptions {
    ...
    public static final class Builder {
        ...
        public PublicKeyCredentialRequestOptions build() {
            ...
            return new PublicKeyCredentialRequestOptions(bArr, d3, str, list, num, tokenBinding, zzayVar == null ? null : zzayVar.toString(), this.zzh, null);
        }
    ...
    PublicKeyCredentialRequestOptions(byte[] bArr, Double d3, String str, List list, Integer num, TokenBinding tokenBinding, String str2, AuthenticationExtensions authenticationExtensions, Long l3) {
        this.zza = (byte[]) Preconditions.checkNotNull(bArr);
        this.zzb = d3;
        this.zzc = (String) Preconditions.checkNotNull(str);
        this.zzd = list;
