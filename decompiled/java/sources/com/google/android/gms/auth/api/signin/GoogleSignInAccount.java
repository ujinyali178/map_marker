...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    GoogleSignInAccount(int i3, String str, String str2, String str3, String str4, Uri uri, String str5, long j3, String str6, List list, String str7, String str8) {
        this.zab = i3;
        this.zad = str;
        this.zae = str2;
        this.zaf = str3;
    ...
    public static GoogleSignInAccount zaa(String str, String str2, String str3, String str4, String str5, String str6, Uri uri, Long l3, String str7, Set set) {
        return new GoogleSignInAccount(3, str, str2, str3, str4, uri, null, l3.longValue(), Preconditions.checkNotEmpty(str7), new ArrayList((Collection) Preconditions.checkNotNull(set)), str5, str6);
    }
    ...
    public void writeToParcel(Parcel parcel, int i3) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 6, getPhotoUrl(), i3, false);
