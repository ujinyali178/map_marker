...
public class zzl {
    ...
    public static List<AccountChangeEvent> getAccountChangeEvents(Context context, int i3, String str) {
        ...
        accountChangeEventsRequest.setEventIndex(i3);
        zzdc.zzd(context);
    ...
    public static TokenData zza(final Context context, final Account account, final String str, Bundle bundle, long j3, Executor executor) {
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
    ...
    static /* synthetic */ TokenData zzb(Account account, String str, Bundle bundle, Context context, IBinder iBinder) {
    ...
    public static void zze(Context context, String str, long j3) {
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
        zzk(context, 8400000);
    ...
    private static Object zzh(Context context, ComponentName componentName, zzk zzkVar, long j3, Executor executor) {
    ...
    private static void zzk(Context context, int i3) {
        try {
            GooglePlayServicesUtilLight.ensurePlayServicesAvailable(context.getApplicationContext(), i3);
