...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    GoogleSignInOptions(int i3, ArrayList arrayList, Account account, boolean z3, boolean z4, boolean z5, String str, String str2, ArrayList arrayList2, String str3) {
        this(i3, arrayList, account, z3, z4, z5, str, str2, zam(arrayList2), str3);
    }
    ...
    */
    ...
    public void writeToParcel(Parcel parcel, int i3) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 3, getAccount(), i3, false);
