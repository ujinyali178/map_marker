...
public final class zzw extends zzbz {
    ...
    zzw(Set set, int i3, String str, int i4, byte[] bArr, PendingIntent pendingIntent, DeviceMetaData deviceMetaData) {
        this.zza = set;
        this.zzb = i3;
        this.zzd = str;
        this.zze = i4;
    ...
    public final void writeToParcel(Parcel parcel, int i3) {
        ...
        if (set.contains(5)) {
            SafeParcelWriter.writeParcelable(parcel, 5, this.zzg, i3, true);
        }
        if (set.contains(6)) {
            SafeParcelWriter.writeParcelable(parcel, 6, this.zzh, i3, true);
        }
