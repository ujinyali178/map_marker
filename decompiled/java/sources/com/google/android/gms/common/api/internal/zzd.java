...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map zzb = Collections.synchronizedMap(new androidx.collection.a());
    private int zzc = 0;
    private Bundle zzd;
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            zzd zzdVar2 = (zzd) fragmentActivity.getSupportFragmentManager().j0("SupportLifecycleFragmentImpl");
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                zzdVar2 = new zzd();
                fragmentActivity.getSupportFragmentManager().p().d(zzdVar2, "SupportLifecycleFragmentImpl").g();
            }
