...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final void zaL(TaskCompletionSource taskCompletionSource, int i3, GoogleApi googleApi) {
        zacd zaa2;
        if (i3 == 0 || (zaa2 = zacd.zaa(this, i3, googleApi.getApiKey())) == null) {
            return;
        }
            ...
            case 18:
                ...
                if (zaceVar.zac == 0) {
                    ...
                    if (telemetryData != null) {
                        ...
                        if (telemetryData.zaa() != zaceVar.zab || (zab3 != null && zab3.size() >= zaceVar.zad)) {
    ...
    final boolean zaG(ConnectionResult connectionResult, int i3) {
        return this.zal.zah(this.zak, connectionResult, i3);
    }
    ...
    public final Task zar(GoogleApi googleApi, ListenerHolder.ListenerKey listenerKey, int i3) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        zaL(taskCompletionSource, i3, googleApi);
    ...
    public final void zaw(GoogleApi googleApi, int i3, BaseImplementation.ApiMethodImpl apiMethodImpl) {
        zae zaeVar = new zae(i3, apiMethodImpl);
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(4, new zach(zaeVar, this.zao.get(), googleApi)));
    }

    public final void zax(GoogleApi googleApi, int i3, TaskApiCall taskApiCall, TaskCompletionSource taskCompletionSource, StatusExceptionMapper statusExceptionMapper) {
    ...
    final void zay(MethodInvocation methodInvocation, int i3, long j3, int i4) {
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(18, new zace(methodInvocation, i3, j3, i4)));
    }

    public final void zaz(ConnectionResult connectionResult, int i3) {
        if (zaG(connectionResult, i3)) {
            return;
        }
        Handler handler = this.zat;
