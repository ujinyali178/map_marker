...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        Field(int i3, int i4, boolean z3, int i5, boolean z4, String str, int i6, String str2, com.google.android.gms.common.server.converter.zaa zaaVar) {
            this.zai = i3;
            this.zaa = i4;
            this.zab = z3;
            this.zac = i5;
        ...
        public final void writeToParcel(Parcel parcel, int i3) {
            ...
            SafeParcelWriter.writeParcelable(parcel, 9, zaa(), i3, false);
    ...
    protected void setIntegerInternal(Field<?, ?> field, String str, int i3) {
        throw new UnsupportedOperationException("Integer not supported");
    }

    protected void setLongInternal(Field<?, ?> field, String str, long j3) {
    ...
    protected void zan(Field field, String str, double d3) {
    ...
    public final void zaq(Field field, float f3) {
        if (field.zak != null) {
            zaE(field, Float.valueOf(f3));
        } else {
            zar(field, field.zae, f3);
        }
    }

    protected void zar(Field field, String str, float f3) {
    ...
    public final void zau(Field field, int i3) {
        if (field.zak != null) {
            zaE(field, Integer.valueOf(i3));
        } else {
            setIntegerInternal(field, field.zae, i3);
        }
    }
