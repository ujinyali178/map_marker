...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApi(Api<O> api, O o3) {
            Preconditions.checkNotNull(api, "Api must not be null");
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiIfAvailable(Api<O> api, O o3, Scope... scopeArr) {
            Preconditions.checkNotNull(api, "Api must not be null");
            Preconditions.checkNotNull(o3, "Null options are not permitted for this Api");
            this.zaj.put(api, o3);
            zab(api, o3, scopeArr);
        ...
        public Builder enableAutoManage(FragmentActivity fragmentActivity, int i3, OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) fragmentActivity);
            Preconditions.checkArgument(i3 >= 0, "clientId must be non-negative");
            this.zal = i3;
        ...
        public Builder setGravityForPopups(int i3) {
            this.zad = i3;
            return this;
        }
    ...
    public abstract ConnectionResult blockingConnect(long j3, TimeUnit timeUnit);
