...
public class WakeLockTracker {
    ...
    public void registerDeadlineEvent(Context context, String str, String str2, String str3, int i3, List<String> list, boolean z3, long j3) {
    }

    public void registerEvent(Context context, String str, int i3, String str2, String str3, String str4, int i4, List<String> list) {
    }

    public void registerEvent(Context context, String str, int i3, String str2, String str3, String str4, int i4, List<String> list, long j3) {
    }
