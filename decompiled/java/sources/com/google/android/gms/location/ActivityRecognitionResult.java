...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public ActivityRecognitionResult(DetectedActivity detectedActivity, long j3, long j4) {
        this(Collections.singletonList(detectedActivity), j3, j4, 0, null);
    }

    public ActivityRecognitionResult(List<DetectedActivity> list, long j3, long j4) {
        this(list, j3, j4, 0, null);
    }

    public ActivityRecognitionResult(List list, long j3, long j4, int i3, Bundle bundle) {
