...
public abstract class zzag extends zzac implements List, RandomAccess {
    ...
    static zzag zzi(Object[] objArr, int i3) {
        return i3 == 0 ? zzai.zza : new zzai(objArr, i3);
    }
    ...
    public zzag subList(int i3, int i4) {
        zzs.zzc(i3, i4, size());
        int i5 = i4 - i3;
        return i5 == size() ? this : i5 == 0 ? zzai.zza : new zzaf(this, i3, i5);
    }

    @Override // java.util.List
    /* renamed from: zzo, reason: merged with bridge method [inline-methods] */
    public final zzak listIterator(int i3) {
        zzs.zzb(i3, size(), "index");
        return isEmpty() ? zza : new zzae(this, i3);
    }
}
