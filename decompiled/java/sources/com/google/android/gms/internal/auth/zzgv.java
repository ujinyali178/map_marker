...
class zzgv extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i3 = 0;
        if (size >= 0) {
            int compareTo = comparable.compareTo(((zzgp) this.zzb.get(size)).zza());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i3 <= size) {
            int i4 = (i3 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzgp) this.zzb.get(i4)).zza());
            if (compareTo2 < 0) {
                size = i4 - 1;
            } else {
                if (compareTo2 <= 0) {
    ...
    public final Object zzl(int i3) {
        zzn();
        Object value = ((zzgp) this.zzb.remove(i3)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzb == zzgvVar.zzb()) {
            for (int i3 = 0; i3 < zzb; i3++) {
                if (!zzg(i3).equals(zzgvVar.zzg(i3))) {
                    return false;
                }
            }
            if (zzb == size) {
            ...
            entrySet = this.zzc;
            entrySet2 = zzgvVar.zzc;
        } else {
            entrySet = entrySet();
            entrySet2 = zzgvVar.entrySet();
        }
    ...
    public final int hashCode() {
        ...
        for (int i4 = 0; i4 < zzb; i4++) {
            i3 += ((zzgp) this.zzb.get(i4)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i4 = this.zza;
        if (size == i4) {
            zzgp zzgpVar = (zzgp) this.zzb.remove(i4 - 1);
            zzm().put(zzgpVar.zza(), zzgpVar.getValue());
        }
        this.zzb.add(i3, new zzgp(this, comparable, obj));
        return null;
    }
