...
public abstract class zzaz extends zzaw implements List, RandomAccess {
    ...
    static zzaz zzg(Object[] objArr, int i3) {
        return i3 == 0 ? zzbc.zza : new zzbc(objArr, i3);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i3 = 0; i3 < size; i3++) {
                        if (zzar.zza(get(i3), list.get(i3))) {
                        }
                    }
                    return true;
                }
    ...
    public zzaz subList(int i3, int i4) {
        zzas.zzc(i3, i4, size());
        int i5 = i4 - i3;
        return i5 == size() ? this : i5 == 0 ? zzbc.zza : new zzay(this, i3, i5);
    }

    @Override // java.util.List
    /* renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zzbg listIterator(int i3) {
        zzas.zzb(i3, size(), "index");
        return isEmpty() ? zza : new zzax(this, i3);
    }
}
