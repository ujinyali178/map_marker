...
public abstract class zzds extends zzdp implements List, RandomAccess {
    ...
    static zzds zzi(Object[] objArr, int i3) {
        return i3 == 0 ? zzdt.zza : new zzdt(objArr, i3);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i3 = 0; i3 < size; i3++) {
                        if (zzdl.zza(get(i3), list.get(i3))) {
                        }
                    }
                    return true;
                }
    ...
    public zzds subList(int i3, int i4) {
        zzdm.zzc(i3, i4, size());
        int i5 = i4 - i3;
        return i5 == size() ? this : i5 == 0 ? zzdt.zza : new zzdr(this, i3, i5);
    }

    @Override // java.util.List
    /* renamed from: zzl, reason: merged with bridge method [inline-methods] */
    public final zzdv listIterator(int i3) {
        zzdm.zzb(i3, size(), "index");
        return isEmpty() ? zza : new zzdq(this, i3);
    }
}
