...
public class GoogleMap {
    ...
    public final void animateCamera(CameraUpdate cameraUpdate, int i3, CancelableCallback cancelableCallback) {
        try {
            Preconditions.checkNotNull(cameraUpdate, "CameraUpdate must not be null.");
            this.zza.animateCameraWithDurationAndCallback(cameraUpdate.zza(), i3, cancelableCallback == null ? null : new zzab(cancelableCallback));
        } catch (RemoteException e3) {
            throw new RuntimeRemoteException(e3);
        }
    }
    ...
    public final void setMapType(int i3) {
        try {
            this.zza.setMapType(i3);
        } catch (RemoteException e3) {
            throw new RuntimeRemoteException(e3);
        }
    }

    public void setMaxZoomPreference(float f3) {
        try {
            this.zza.setMaxZoomPreference(f3);
        } catch (RemoteException e3) {
            throw new RuntimeRemoteException(e3);
        }
    }

    public void setMinZoomPreference(float f3) {
        try {
            this.zza.setMinZoomPreference(f3);
        } catch (RemoteException e3) {
            throw new RuntimeRemoteException(e3);
        }
    }
    ...
    public final void setPadding(int i3, int i4, int i5, int i6) {
        try {
            this.zza.setPadding(i3, i4, i5, i6);
        } catch (RemoteException e3) {
            throw new RuntimeRemoteException(e3);
        }
    }
