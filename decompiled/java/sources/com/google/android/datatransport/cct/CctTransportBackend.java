...
final class CctTransportBackend implements TransportBackend {
    ...
    static final class HttpResponse {
        ...
        HttpResponse(int i3, URL url, long j3) {
            this.code = i3;
            this.redirectUrl = url;
            this.nextRequestMillis = j3;
        }
    }
    ...
    CctTransportBackend(Context context, Clock clock, Clock clock2, int i3) {
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.e(LOG_TAG, "Unable to find version code for package", e3);
            return -1;
        }
    }
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            ...
            if (i3 < 500 && i3 != 404) {
                return i3 == 400 ? BackendResponse.invalidPayload() : BackendResponse.fatalError();
            }
            return BackendResponse.transientError();
        } catch (IOException e3) {
            Logging.e(LOG_TAG, "Could not make request to the backend", e3);
            return BackendResponse.transientError();
        }
    }
}
