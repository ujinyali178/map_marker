...
final class AutoValue_EventInternal extends EventInternal {
    ...
    static final class Builder extends EventInternal.Builder {
        ...
        public EventInternal.Builder setEventMillis(long j3) {
            this.eventMillis = Long.valueOf(j3);
            return this;
        }
        ...
        public EventInternal.Builder setUptimeMillis(long j3) {
            this.uptimeMillis = Long.valueOf(j3);
            return this;
        }
    }

    private AutoValue_EventInternal(String str, Integer num, EncodedPayload encodedPayload, long j3, long j4, Map<String, String> map) {
        this.transportName = str;
        this.code = num;
        this.encodedPayload = encodedPayload;
        this.eventMillis = j3;
    ...
    public int hashCode() {
        ...
        long j3 = this.eventMillis;
        int i3 = (hashCode2 ^ ((int) (j3 ^ (j3 >>> 32)))) * 1000003;
        long j4 = this.uptimeMillis;
        return ((i3 ^ ((int) (j4 ^ (j4 >>> 32)))) * 1000003) ^ this.autoMetadata.hashCode();
    }
