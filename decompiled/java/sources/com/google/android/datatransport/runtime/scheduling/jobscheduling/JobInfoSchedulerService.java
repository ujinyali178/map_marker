...
public class JobInfoSchedulerService extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        TransportRuntime.getInstance().getUploader().upload(priority.build(), i4, new Runnable() { // from class: com.google.android.datatransport.runtime.scheduling.jobscheduling.b
