...
public abstract class EventInternal {
    ...
    public static abstract class Builder {
        public final Builder addMetadata(String str, int i3) {
            getAutoMetadata().put(str, String.valueOf(i3));
            return this;
        }

        public final Builder addMetadata(String str, long j3) {
        ...
        public abstract Builder setEventMillis(long j3);

        public abstract Builder setTransportName(String str);

        public abstract Builder setUptimeMillis(long j3);
    }
