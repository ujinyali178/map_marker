...
jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r4v0 org.checkerframework.checker.formatter.qual.ConversionCategory, still in use, count: 1, list:
  (r4v0 org.checkerframework.checker.formatter.qual.ConversionCategory) from 0x00ba: FILLED_NEW_ARRAY 
  (r4v0 org.checkerframework.checker.formatter.qual.ConversionCategory)
  (r5v1 org.checkerframework.checker.formatter.qual.ConversionCategory)
  (r9v1 org.checkerframework.checker.formatter.qual.ConversionCategory)
  (r8v2 org.checkerframework.checker.formatter.qual.ConversionCategory)
...
public final class ConversionCategory {
    ...
    static {
        ...
        conversionCategoriesWithChar = new ConversionCategory[]{r4, conversionCategory, conversionCategory2, conversionCategory3, conversionCategory4};
    ...
    public static ConversionCategory fromConversionChar(char c3) {
        for (ConversionCategory conversionCategory : conversionCategoriesWithChar) {
            if (conversionCategory.chars.contains(String.valueOf(c3))) {
