...
public class FileFilterUtils {
    ...
    public static IOFileFilter ageFileFilter(long j3, boolean z3) {
        return new AgeFileFilter(j3, z3);
    }
    ...
    public static IOFileFilter ageFileFilter(File file, boolean z3) {
    ...
    public static IOFileFilter ageFileFilter(Date date, boolean z3) {
    ...
    private static <T extends Collection<File>> T filter(IOFileFilter iOFileFilter, Iterable<File> iterable, T t3) {
    ...
    public static IOFileFilter sizeFileFilter(long j3, boolean z3) {
        return new SizeFileFilter(j3, z3);
    }

    public static IOFileFilter sizeRangeFileFilter(long j3, long j4) {
        return new AndFileFilter(new SizeFileFilter(j3, true), new SizeFileFilter(j4 + 1, false));
    }
