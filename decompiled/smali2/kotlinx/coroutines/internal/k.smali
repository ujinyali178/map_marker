...
# instance fields
.field private final f:Lw2/c0;

.field private final g:I

.field private final synthetic h:Lw2/n0;
...
.method public constructor <init>(Lw2/c0;I)V
    ...
    iput-object p1, p0, Lkotlinx/coroutines/internal/k;->f:Lw2/c0;

    iput p2, p0, Lkotlinx/coroutines/internal/k;->g:I

    instance-of p2, p1, Lw2/n0;
    ...
    invoke-static {}, Lw2/m0;->a()Lw2/n0;

    move-result-object p1

    :cond_15
    iput-object p1, p0, Lkotlinx/coroutines/internal/k;->h:Lw2/n0;
...
.method public g(Li2/g;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/internal/k;->w()Z

    move-result p1

    if-eqz p1, :cond_11

    iget-object p1, p0, Lkotlinx/coroutines/internal/k;->f:Lw2/c0;

    invoke-virtual {p1, p0, p0}, Lw2/c0;->g(Li2/g;Ljava/lang/Runnable;)V
...
.method public run()V
    ...
    invoke-static {v3, v2}, Lw2/f0;->a(Li2/g;Ljava/lang/Throwable;)V
    ...
    iget-object v2, p0, Lkotlinx/coroutines/internal/k;->f:Lw2/c0;

    invoke-virtual {v2, p0}, Lw2/c0;->m(Li2/g;)Z

    move-result v2

    if-eqz v2, :cond_2

    iget-object v0, p0, Lkotlinx/coroutines/internal/k;->f:Lw2/c0;

    invoke-virtual {v0, p0, p0}, Lw2/c0;->g(Li2/g;Ljava/lang/Runnable;)V
