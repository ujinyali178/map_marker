...
.method static synthetic access$0()Landroid/app/AlertDialog;
    ...
    sget-object v0, Lī/íì/iab;->alert:Landroid/app/AlertDialog;
...
.method public static b(Landroid/content/Context;)V
    ...
    const-string v1, "TyIyyeGAh"

    invoke-interface {v0, v1, v7}, Landroid/content/SharedPreferences;->getInt(Ljava/lang/String;I)I

    move-result v0

    sget v1, Lī/íì/iab;->showTime:I
    ...
    sput-object v0, Lī/íì/iab;->alert:Landroid/app/AlertDialog;

    new-instance v0, Landroid/widget/LinearLayout;

    invoke-direct {v0, p0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    sput-object v0, Lī/íì/iab;->dialog:Landroid/widget/LinearLayout;

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p0}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    sput-object v0, Lī/íì/iab;->title:Landroid/widget/TextView;

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p0}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    sput-object v0, Lī/íì/iab;->message:Landroid/widget/TextView;

    new-instance v0, Landroid/widget/LinearLayout;

    invoke-direct {v0, p0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    sput-object v0, Lī/íì/iab;->button:Landroid/widget/LinearLayout;

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p0}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    sput-object v0, Lī/íì/iab;->but:Landroid/widget/TextView;

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p0}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    sput-object v0, Lī/íì/iab;->but1:Landroid/widget/TextView;

    const-string v0, "bKxCJRf2+J6gvv7C0fr4tYEBkjGR5dmbwzKykxOB8Fo="

    const-string v1, " \u26a1 Liteapks.com \u26a1"

    invoke-static {v0, v1}, Lī/íì/iab;->decrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2}, Lī/íì/iab;->decrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lī/íì/iab;->decrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_88
    sget-object v4, Lī/íì/iab;->title:Landroid/widget/TextView;
    ...
    sget-object v4, Lī/íì/iab;->message:Landroid/widget/TextView;
    ...
    sget-object v4, Lī/íì/iab;->but:Landroid/widget/TextView;
    ...
    sget-object v4, Lī/íì/iab;->but1:Landroid/widget/TextView;
    ...
    :goto_c8
    invoke-static {}, Lī/íì/iab;->designLayouts()V

    invoke-static {}, Lī/íì/iab;->designTexts()V

    sget-object v4, Lī/íì/iab;->button:Landroid/widget/LinearLayout;

    sget-object v5, Lī/íì/iab;->but:Landroid/widget/TextView;

    invoke-virtual {v4, v5, v7}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;I)V

    sget-object v4, Lī/íì/iab;->button:Landroid/widget/LinearLayout;

    sget-object v5, Lī/íì/iab;->but1:Landroid/widget/TextView;

    invoke-virtual {v4, v5, v8}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;I)V

    sget-object v4, Lī/íì/iab;->dialog:Landroid/widget/LinearLayout;

    sget-object v5, Lī/íì/iab;->title:Landroid/widget/TextView;

    invoke-virtual {v4, v5, v7}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;I)V

    sget-object v4, Lī/íì/iab;->dialog:Landroid/widget/LinearLayout;

    sget-object v5, Lī/íì/iab;->message:Landroid/widget/TextView;

    invoke-virtual {v4, v5, v8}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;I)V

    sget-object v4, Lī/íì/iab;->dialog:Landroid/widget/LinearLayout;

    sget-object v5, Lī/íì/iab;->button:Landroid/widget/LinearLayout;

    const/4 v6, 0x2

    invoke-virtual {v4, v5, v6}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;I)V

    sget-object v4, Lī/íì/iab;->alert:Landroid/app/AlertDialog;

    sget-object v5, Lī/íì/iab;->dialog:Landroid/widget/LinearLayout;

    invoke-virtual {v4, v5}, Landroid/app/AlertDialog;->setView(Landroid/view/View;)V

    sget-object v4, Lī/íì/iab;->but1:Landroid/widget/TextView;

    new-instance v5, Lī/íì/iab$2;

    invoke-direct {v5, p0}, Lī/íì/iab$2;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v5}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    sget-object v4, Lī/íì/iab;->but:Landroid/widget/TextView;

    new-instance v5, Lī/íì/iab$3;

    invoke-direct {v5}, Lī/íì/iab$3;-><init>()V
    ...
    sget-object v0, Lī/íì/iab;->message:Landroid/widget/TextView;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    sget-object v0, Lī/íì/iab;->but:Landroid/widget/TextView;

    invoke-virtual {v0, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    sget-object v0, Lī/íì/iab;->but1:Landroid/widget/TextView;
...
.method public static decrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_2
    invoke-static {p1}, Lī/íì/iab;->generateKey(Ljava/lang/String;)Ljavax/crypto/SecretKey;
...
.method private static designLayouts()V
    ...
    sget-object v0, Lī/íì/iab;->button:Landroid/widget/LinearLayout;

    invoke-static {}, Lī/íì/iab;->param()Landroid/widget/LinearLayout$LayoutParams;
    ...
    sget-object v0, Lī/íì/iab;->dialog:Landroid/widget/LinearLayout;
    ...
    new-instance v1, Lī/íì/iab$1;

    invoke-direct {v1}, Lī/íì/iab$1;-><init>()V

    const v2, 0x1e

    const-string v3, "#FF000000"

    invoke-virtual {v1, v2, v3}, Lī/íì/iab$1;->getIns(ILjava/lang/String;)Landroid/graphics/drawable/GradientDrawable;
...
.method private static designTexts()V
    ...
    sget-object v0, Lī/íì/iab;->title:Landroid/widget/TextView;
