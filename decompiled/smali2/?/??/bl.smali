...
.method static final constructor <clinit>()V
    ...
    sput-boolean v0, Lī/íì/bl;->drk:Z
...
.method public static a2()[F
    ...
    .array-data 4
        ...
        0x41e60000    # 28.75f
        0x41000000    # 8.0f
        0x46583d00    # 13839.25f
        0x465c7b00    # 14110.75f
        0x41700000    # 15.0f
        0x413c0000    # 11.75f
        0x41c20000    # 24.25f
        0x41780000    # 15.5f
...
.method public static w(Landroid/content/Context;)Lī/íì/bl;
    .registers 22
    ...
    :goto_a4
    invoke-static {}, Lī/íì/bl;->a1()[F

    move-result-object v8

    array-length v8, v8

    if-lt v6, v8, :cond_2e9
    ...
    :goto_b7
    invoke-static {}, Lī/íì/bl;->a2()[F

    move-result-object v8

    array-length v8, v8

    if-lt v6, v8, :cond_2fc
    ...
    move-object v6, v0
    :try_end_f3
    .catch Ljava/lang/Exception; {:try_start_e7 .. :try_end_f3} :catch_3a8
    ...
    invoke-interface {v8, v7, v0, v6}, Landroid/text/Spannable;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;
    ...
    :goto_124
    invoke-static {}, Lī/íì/bl;->a31()[F

    move-result-object v8

    array-length v8, v8

    if-lt v6, v8, :cond_353
    ...
    :goto_134
    invoke-static {}, Lī/íì/bl;->a32()[F

    move-result-object v8

    array-length v8, v8

    if-lt v6, v8, :cond_366
    ...
    invoke-virtual {v11, v6, v7, v8, v0}, Landroid/widget/TextView;->setPadding(IIII)V
    ...
    invoke-virtual {v13, v6, v7, v8, v0}, Landroid/widget/TextView;->setPadding(IIII)V
    ...
    invoke-virtual {v13, v6, v7}, Landroid/widget/TextView;->setTypeface(Landroid/graphics/Typeface;I)V
    ...
    invoke-virtual {v14, v6, v7, v8, v0}, Landroid/widget/TextView;->setPadding(IIII)V
    ...
    new-instance v6, Lī/íì/bl1;

    invoke-direct {v6}, Lī/íì/bl1;-><init>()V
    ...
    invoke-virtual {v6, v7, v8}, Lī/íì/bl1;->getIns(II)Landroid/graphics/drawable/GradientDrawable;

    move-result-object v6

    invoke-virtual {v13, v6}, Landroid/view/View;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    new-instance v6, Lī/íì/bl2;

    invoke-direct {v6}, Lī/íì/bl2;-><init>()V
    ...
    invoke-virtual {v6, v7, v8}, Lī/íì/bl2;->getIns(II)Landroid/graphics/drawable/GradientDrawable;

    move-result-object v6

    invoke-virtual {v14, v6}, Landroid/view/View;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v12, v6, v7, v8, v0}, Landroid/view/View;->setPadding(IIII)V
    ...
    invoke-virtual {v12, v13, v7}, Landroid/view/ViewGroup;->addView(Landroid/view/View;I)V

    const/4 v7, 0x1

    invoke-virtual {v12, v15, v7}, Landroid/view/ViewGroup;->addView(Landroid/view/View;I)V

    const/4 v7, 0x2

    invoke-virtual {v12, v14, v7}, Landroid/view/ViewGroup;->addView(Landroid/view/View;I)V
    ...
    sget-boolean v7, Lī/íì/bl;->drk:Z
    ...
    invoke-virtual {v5, v12, v7}, Landroid/view/ViewGroup;->addView(Landroid/view/View;I)V
    ...
    invoke-virtual {v5, v7, v8, v9, v11}, Landroid/view/View;->setPadding(IIII)V
    ...
    new-instance v5, Lī/íì/bl3;

    invoke-direct {v5, v4, v10}, Lī/íì/bl3;-><init>(Landroid/app/AlertDialog;Landroid/app/Activity;)V

    invoke-virtual {v14, v5}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v5, Lī/íì/bl4;

    invoke-direct {v5, v4}, Lī/íì/bl4;-><init>(Landroid/app/AlertDialog;)V
    ...
    :try_end_2e3
    .catch Ljava/lang/Exception; {:try_start_2ca .. :try_end_2e3} :catch_3a5

    :cond_2e3
    new-instance v4, Lī/íì/bl;

    invoke-direct {v4}, Lī/íì/bl;-><init>()V
    ...
    new-instance v18, Lī/íì/bl0;

    invoke-direct/range {v18 .. v18}, Lī/íì/bl0;-><init>()V
