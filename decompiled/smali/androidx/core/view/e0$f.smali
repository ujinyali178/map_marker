.class Landroidx/core/view/e0$f;
...
.method protected final a()V
    ...
    iget-object v0, p0, Landroidx/core/view/e0$f;->b:[Landroidx/core/graphics/b;

    if-eqz v0, :cond_58

    const/4 v1, 0x1

    invoke-static {v1}, Landroidx/core/view/e0$m;->a(I)I

    move-result v2

    aget-object v0, v0, v2

    iget-object v2, p0, Landroidx/core/view/e0$f;->b:[Landroidx/core/graphics/b;

    const/4 v3, 0x2

    invoke-static {v3}, Landroidx/core/view/e0$m;->a(I)I
    ...
    invoke-virtual {v2, v3}, Landroidx/core/view/e0;->f(I)Landroidx/core/graphics/b;
    ...
    invoke-virtual {v0, v1}, Landroidx/core/view/e0;->f(I)Landroidx/core/graphics/b;
    ...
    invoke-virtual {p0, v0}, Landroidx/core/view/e0$f;->f(Landroidx/core/graphics/b;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/core/view/e0$f;->e(Landroidx/core/graphics/b;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/core/view/e0$f;->c(Landroidx/core/graphics/b;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/core/view/e0$f;->g(Landroidx/core/graphics/b;)V
