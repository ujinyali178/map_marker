...
.method public setDefaultNotificationChannelId(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lg/c;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
...
.method final zad(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1}, Landroidx/fragment/app/FragmentActivity;->getSupportFragmentManager()Landroidx/fragment/app/w;
...
.method final zae(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    new-instance v6, Landroidx/core/app/s$d;

    invoke-direct {v6, p1}, Landroidx/core/app/s$d;-><init>(Landroid/content/Context;)V

    invoke-virtual {v6, v3}, Landroidx/core/app/s$d;->l(Z)Landroidx/core/app/s$d;

    move-result-object v6

    invoke-virtual {v6, v3}, Landroidx/core/app/s$d;->e(Z)Landroidx/core/app/s$d;

    move-result-object v6

    invoke-virtual {v6, v0}, Landroidx/core/app/s$d;->j(Ljava/lang/CharSequence;)Landroidx/core/app/s$d;

    move-result-object v0

    new-instance v6, Landroidx/core/app/s$b;

    invoke-direct {v6}, Landroidx/core/app/s$b;-><init>()V

    invoke-virtual {v6, v1}, Landroidx/core/app/s$b;->h(Ljava/lang/CharSequence;)Landroidx/core/app/s$b;

    move-result-object v6

    invoke-virtual {v0, v6}, Landroidx/core/app/s$d;->p(Landroidx/core/app/s$f;)Landroidx/core/app/s$d;
    ...
    invoke-virtual {v0, v1}, Landroidx/core/app/s$d;->o(I)Landroidx/core/app/s$d;

    move-result-object v1

    invoke-virtual {v1, p3}, Landroidx/core/app/s$d;->n(I)Landroidx/core/app/s$d;
    ...
    invoke-virtual {v0, v1, v4, p4}, Landroidx/core/app/s$d;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroidx/core/app/s$d;

    goto :goto_b9

    :cond_95
    invoke-virtual {v0, p4}, Landroidx/core/app/s$d;->h(Landroid/app/PendingIntent;)Landroidx/core/app/s$d;
    ...
    invoke-virtual {v0, v6}, Landroidx/core/app/s$d;->o(I)Landroidx/core/app/s$d;
    ...
    invoke-virtual {v6, v4}, Landroidx/core/app/s$d;->q(Ljava/lang/CharSequence;)Landroidx/core/app/s$d;
    ...
    invoke-virtual {v4, v6, v7}, Landroidx/core/app/s$d;->r(J)Landroidx/core/app/s$d;

    move-result-object v4

    invoke-virtual {v4, p4}, Landroidx/core/app/s$d;->h(Landroid/app/PendingIntent;)Landroidx/core/app/s$d;

    move-result-object p4

    invoke-virtual {p4, v1}, Landroidx/core/app/s$d;->i(Ljava/lang/CharSequence;)Landroidx/core/app/s$d;
    ...
    invoke-static {v5, v1}, Lg/c;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-static {v5, p4}, Lg/b;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
    ...
    :cond_f5
    :goto_f5
    invoke-virtual {v0, v1}, Landroidx/core/app/s$d;->f(Ljava/lang/String;)Landroidx/core/app/s$d;

    :goto_f8
    invoke-virtual {v0}, Landroidx/core/app/s$d;->b()Landroid/app/Notification;
